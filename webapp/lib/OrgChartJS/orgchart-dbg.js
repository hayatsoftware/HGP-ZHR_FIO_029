var OrgChart = function(t, e) {
    ...
    if (this._event_id = OrgChart._guid(),
    !this.config.searchFields.length && this.config.nodeBinding)
        for (var n in this.config.nodeBinding)
            -1 == n.indexOf("img") && "function" != typeof this.config.nodeBinding[n] && this.config.searchFields.push(this.config.nodeBinding[n]);
    OrgChart._validateConfig(this.config) && (this._vScroll = {},
    ...
    this.manager = new OrgChart.manager(this.config,this._layoutConfigs),
    ...
    this.config.nodeCircleMenuUI ? this.nodeCircleMenuUI = this.config.nodeCircleMenuUI : this.nodeCircleMenuUI = new OrgChart.circleMenuUI,
    ...
    this.config.xScrollUI || (this.xScrollUI = new OrgChart.xScrollUI(this.element,this.config,(function() {
        return {
    ...
    this.config.nodes.length > 0 && this._draw(!1, OrgChart.action.init))
};
...
OrgChart.prototype.load = function(t) {
    return this.config.nodes = t,
    this._draw(!1, OrgChart.action.init),
    this
}
,
...
OrgChart.prototype.on = function(t, e) {
    return OrgChart.events.on(t, e, this._event_id),
    this
}
,
OrgChart.prototype.draw = function(t, e, r) {
    null == t && (t = OrgChart.action.update),
    this._draw(!1, t, e, r)
}
,
OrgChart.prototype._draw = function(t, e, r, i) {
    ...
    this.manager.read(t, this.width(), this.height(), n, e, r, (function(t) {
        e != OrgChart.action.exporting && (a.nodes = t.nodes,
        ...
        OrgChart.events.publish("prerender", [a, n]),
        o = n.content;
        for (var c = 0; c < t.visibleNodeIds.length; c++) {
            var d = t.nodes[t.visibleNodeIds[c]]
              , g = a._get(d.id);
            OrgChart.RENDER_LINKS_BEFORE_NODES && (o += a.ui.link(d, a, l, t.bordersByRootIdAndLevel, t.nodes, e)),
            o += a.ui.node(d, g, t.animations, a.config, void 0, void 0, void 0, e, l, a)
        }
        for (c = 0; c < t.visibleNodeIds.length; c++) {
            d = t.nodes[t.visibleNodeIds[c]];
            OrgChart.RENDER_LINKS_BEFORE_NODES || (o += a.ui.link(d, a, l, t.bordersByRootIdAndLevel, t.nodes, e)),
            o += a.ui.expandCollapseBtn(a, d, a._layoutConfigs, e, l)
        }
        n = {
            content: o,
            res: t
        };
        if (OrgChart.events.publish("render", [a, n]),
        o = n.content,
        t = n.res,
        o += a.ui.lonely(a.config),
        e !== OrgChart.action.exporting) {
            e !== OrgChart.action.centerNode && e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update || (h = s),
            ...
            )) : !s || !a.response || s[0] == a.response.viewBox[0] && s[1] == a.response.viewBox[1] && s[2] == a.response.viewBox[2] && s[3] == a.response.viewBox[3] || e !== OrgChart.action.insert && e !== OrgChart.action.expand && e !== OrgChart.action.collapse && e !== OrgChart.action.update && e !== OrgChart.action.init ? 0 == m[0].length && (u || (i && i(),
            OrgChart.events.publish("redraw", [a]),
            u = !0)) : OrgChart.anim(a.getSvg(), {
                viewbox: s
            }, {
                viewbox: a.response.viewBox
            ...
            a._initialized || (a._initialized = !0,
...
OrgChart.prototype.getScale = function(t) {
    return t || (t = this.getViewBox()),
    OrgChart.getScale(t, this.width(), this.height(), this.config.scaleInitial, this.config.scaleMax, this.config.scaleMin)
}
,
...
OrgChart.prototype.toggleFullScreen = function() {
    ...
    document.fullscreenElement == this.element || document.webkitFullscreenElement == this.element || document.mozFullScreenElement == this.element || document.msFullscreenElement == this.element ? (document.exitFullscreen ? document.exitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen ? document.webkitExitFullscreen() : document.msExitFullscreen && document.msExitFullscreen(),
    t && (t.innerHTML = OrgChart.toolbarUI.openFullScreenIcon)) : (this.element.requestFullscreen ? this.element.requestFullscreen() : this.element.mozRequestFullScreen ? this.element.mozRequestFullScreen() : this.element.webkitRequestFullscreen ? this.element.webkitRequestFullscreen() : this.element.msRequestFullscreen && this.element.msRequestFullscreen(),
...
OrgChart.prototype.search = function(t, e, r) {
    return OrgChart.isNEU(e) && (e = this.config.searchFields),
    OrgChart.isNEU(r) && (r = e),
    OrgChart._search.search(this.config.nodes, t, e, r, this.config.searchDisplayField, this.config.searchFieldsWeight)
}
,
...
OrgChart.prototype._showAfterAnimation = function() {
    for (var t = this.element.getElementsByTagName("text"), e = 0; e < t.length; e++)
        t[e].style.display = "";
...
OrgChart.prototype.stateToUrl = function() {
    if (this.manager.state) {
        var t = {};
        return t.exp = this.manager.state.exp.join("*"),
        t.min = this.manager.state.min.join("*"),
        t.adjustify = this.manager.state.adjustify.x + "*" + this.manager.state.adjustify.y,
...
OrgChart.localStorage.setItem = function(t, e) {
    try {
        ...
        t.code == t.QUOTA_EXCEEDED_ERR ? (console.warn("Local storage quota exceeded"),
        localStorage.clear()) : (console.error("Local storage error code:" + t.code),
        console.error(t))
    }
}
,
...
OrgChart.prototype.updateNode = function(t, e, r) {
    ...
    this._draw(!1, OrgChart.action.update, {
        ...
        i.ripple(t.id),
        e && e(),
        OrgChart.events.publish("updated", [i, a, t])
    }
    ))
}
,
...
OrgChart.prototype.removeNode = function(t, e, r) {
    ...
    this._draw(!1, OrgChart.action.update, null, (function() {
        i.config.sticky && OrgChart._moveToBoundaryArea(i.getSvg(), i.getViewBox(), i.response.boundary),
        e && e(),
        OrgChart.events.publish("removed", [i, t, a])
    }
    )),
    !0
}
...
OrgChart.prototype.remove = function(t) {
    ...
    if (e)
        for (var r = this.config.nodes.length - 1; r >= 0; r--)
            this.config.nodes[r].pid != t && this.config.nodes[r].stpid != t || (this.config.nodes[r].pid = e.pid,
...
OrgChart.prototype._getNewPidsAndStpidsForIds = function(t) {
    ...
    if (e)
        for (var a = this.config.nodes.length - 1; a >= 0; a--)
            this.config.nodes[a].pid == t ? r[this.config.nodes[a].id] = e.pid : this.config.nodes[a].stpid == t && (i[this.config.nodes[a].id] = e.stpid);
    return {
        newPidsForIds: r,
        newStpidsForIds: i
    }
...
OrgChart.prototype.addNode = function(t, e, r) {
    var i = this;
    if (!0 === r && !1 === OrgChart.events.publish("add", [this, t]))
        return !1;
    this.add(t),
    i._draw(!1, OrgChart.action.insert, {
        id: t.pid,
        insertedNodeId: t.id
    }, (function() {
        i.ripple(t.id),
        e && e(),
        OrgChart.events.publish("added", [i, t.id])
    }
    )),
...
OrgChart.prototype.add = function(t) {
    return null == t.id && console.error("Call addNode without id"),
...
,
void 0 === OrgChart && (OrgChart = {}),
OrgChart.anim = function(t, e, r, i, a, n, o) {
    ...
    l = setInterval((function() {
        for (var d = 0; d < t.length; d++)
            for (var g in r[d]) {
                ...
                case "d":
                    var f = a((h * s - s) / i) * (r[d][g][0] - e[d][g][0]) + e[d][g][0]
                      , u = a((h * s - s) / i) * (r[d][g][1] - e[d][g][1]) + e[d][g][1];
                    t[d].setAttribute("d", t[d].getAttribute("d") + " L" + f + " " + u);
                    break;
                case "r":
...
OrgChart.anim.inOutPow = function(t) {
    ...
    if (t > 1)
        return 1;
    if ((t *= 2) < 1)
        return OrgChart.anim.inPow(t, 2) / 2;
...
OrgChart.prototype._attachEventHandlers = function(t) {
    if (this.config.interactive) {
        t = this.getSvg();
        this.config.enableTouch || OrgChart.isMobile() ? (this._addEvent(t, "touchstart", this._globalMouseDownHandler),
        this._addEvent(t, "touchend", this._globalClickHandler)) : (this._addEvent(t, "mousedown", this._globalMouseDownHandler),
        ...
        this.config.mouseScrool != OrgChart.action.zoom && this.config.mouseScrool != OrgChart.action.ctrlZoom || (this._addEvent(t, "DOMMouseScroll", this._mouseScrollHandler),
...
OrgChart.prototype._addEvent = function(t, e, r, i) {
    ...
    t.getListenerList[e + i]) || (a = this,
    n = r,
    r = function() {
        if (n)
            return n.apply(a, [this, arguments[0]])
    }
    ,
    t.addEventListener ? "mousewheel" == e ? t.addEventListener(e, o, {
        ...
        return !1 === e && (window.event.returnValue = !1,
...
OrgChart.prototype._removeEvent = function(t, e) {
    if (t.getListenerList[e]) {
        ...
        delete t.getListenerList[e]
    }
}
,
void 0 === OrgChart && (OrgChart = {}),
OrgChart.VERSION = "8.01.03",
...
OrgChart._intersects = function(t, e, r) {
    ...
    return 0 !== (l = (n - i) * (p - d) - (g - c) * (o - a)) && (s = ((a - o) * (g - i) + (n - i) * (p - a)) / l,
    0 < (h = ((p - d) * (g - i) + (c - g) * (p - a)) / l) && h < 1 && 0 < s && s < 1)
}
,
...
OrgChart._addPointTop = function(t, e, r, i, a) {
    var n, o, l;
    return "left" == a ? n = t.leftNeighbor ? t.x + (t.leftNeighbor.x + t.leftNeighbor.w - t.x) / 2 : t.x - r.siblingSeparation / 2 : "right" == a && (n = t.rightNeighbor ? t.x + t.w + (t.rightNeighbor.x - (t.x + t.w)) / 2 : t.x + t.w + r.siblingSeparation / 2),
...
OrgChart._addPointLeft = function(t, e, r, i, a) {
    ...
    return "bottom" == a ? n = t.rightNeighbor ? t.y + t.h + (t.rightNeighbor.y - (t.y + t.h)) / 2 : t.y + t.h + r.siblingSeparation / 2 : "top" == a && (n = t.leftNeighbor ? t.y + (t.leftNeighbor.y + t.leftNeighbor.h - t.y) / 2 : t.y - r.siblingSeparation / 2),
...
OrgChart.editUI.prototype.show = function(t, e, r) {
    if (this.hide(),
    !1 === OrgChart.events.publish("show", [this, t]))
        return !1;
    var i = this
      , a = this.content(t, e, r);
    this.obj.element.appendChild(a.element),
    OrgChart.input.init(this.obj.element),
    r ? !e && a.focusId && OrgChart.editUI.ficusElement(a.focusId) : this.interval = OrgChart.anim(a.element, {
        right: -20,
        opacity: 0
    }, {
        right: 0,
    ...
    this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", (function(t) {
        ...
        a.nextElementSibling.addEventListener("click", (function(t) {
            ...
            if (OrgChart.isNEU(a.value) || r)
                ...
                e.parentNode.insertAdjacentHTML("beforebegin", n.html),
                e.style.display = "",
                OrgChart.input.init(e.parentNode.previousSibling),
    ...
    this.obj.element.querySelector("[data-boc-edit-from-btns]").addEventListener("click", (function(e) {
        for (var r = e.target; r && r.hasAttribute && !r.hasAttribute("data-edit-from-btn"); )
            r = r.parentNode;
        if (r && r.hasAttribute) {
...
OrgChart.editUI.ficusElement = function(t) {
    if (!OrgChart.isNEU(t)) {
        ...
        e && (e.focus(),
        e.value && e.value.length && (e.selectionStart = e.selectionEnd = e.value.length))
    }
}
,
OrgChart.editUI.prototype.content = function(t, e, r, i, a) {
    var n, o = this.obj.config.editForm.readOnly, l = JSON.parse(JSON.stringify(this.obj.config.editForm.elements)), s = this.obj.config.editForm.addMore, h = this.obj.config.editForm.buttons, c = this.obj.config.editForm.titleBinding, d = this.obj.config.editForm.photoBinding, g = this.obj.getNode(t), p = this.obj._get(t), f = OrgChart.t(g.templateName, g.min, this.obj.getScale()), u = p[c], m = p[d];
    if (this.obj.config.editForm.generateElementsFromFields)
        for (var C = 0; C < this.fields.length; C++) {
            var b = this.fields[C];
            if ("tags" != b) {
                for (var O = !1, v = 0; v < l.length; v++) {
                    if (Array.isArray(l[v])) {
                        for (var x = 0; x < l[v].length; x++)
                            if (b == l[v][x].binding) {
                                O = !0;
                                break
                            }
    ...
    OrgChart.isNEU(u) && (u = ""),
    m = OrgChart.isNEU(m) ? OrgChart.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${m}"></img>`;
    var y = !e
      , _ = e ? "display:none;" : ""
      , w = e || !s ? "display:none;" : ""
      , k = f.editFormHeaderColor ? `style="background-color:${f.editFormHeaderColor};"` : ""
      , S = document.createElement("form");
    if (S.setAttribute("data-boc-edit-form", ""),
    S.classList.add("boc-edit-form"),
    S.classList.add(this.obj.config.mode),
    S.classList.add(g.templateName),
    S.classList.add(OrgChart.ui._defsIds[g.templateName]),
    Array.isArray(g.tags) && g.tags.length)
        for (C = 0; C < g.tags.length; C++)
            S.classList.add(g.tags[C]);
    S.style.display = "flex",
    S.style.opacity = r ? 1 : 0,
    S.style.right = r ? 0 : "-20px",
    i && (S.style.width = i);
    var I = []
      , A = a ? "" : '<svg data-edit-from-close class="boc-edit-form-close"><path style="fill:#ffffff;" d="M21.205,5.007c-0.429-0.444-1.143-0.444-1.587,0c-0.429,0.429-0.429,1.143,0,1.571l8.047,8.047H1.111 C0.492,14.626,0,15.118,0,15.737c0,0.619,0.492,1.127,1.111,1.127h26.554l-8.047,8.032c-0.429,0.444-0.429,1.159,0,1.587 c0.444,0.444,1.159,0.444,1.587,0l9.952-9.952c0.444-0.429,0.444-1.143,0-1.571L21.205,5.007z"></path></svg>';
    return S.innerHTML = `<div>\n                        <div class="boc-edit-form-header" ${k}>\n                            ${A}\n                            <h1 class="boc-edit-form-title">${u}</h1>\n                            <div class="boc-edit-form-avatar">${m}</div>                        \n                        </div>\n                        <div data-boc-edit-from-btns class="boc-edit-form-instruments">\n                        ${function() {
        if (a)
            return "";
        var t = "";
        for (var r in h) {
            var i = h[r];
            OrgChart.isNEU(i) || (y && i.hideIfEditMode || e && i.hideIfDetailsMode || o && "Edit" == i.text || (t += `<div data-edit-from-btn='${r}' class="boc-img-button" ${k} title="${i.text}">${i.icon}</div>`))
        }
        return t
        ...
        for (var t = "", r = 0; r < l.length; r++) {
            ...
            if (Array.isArray(i)) {
                ...
                for (var a = 0; a < i.length; a++) {
                    var o = i[a]
                      , s = OrgChart.elements[o.type](p, o, "unset", e);
                    !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id),
                    OrgChart.isNEU(s.value) || I.push(`${o.label}: ${s.value}`),
                    t += s.html
                }
                t += "</div>"
            } else {
                s = OrgChart.elements[i.type](p, i, "280px", e);
                !OrgChart.isNEU(s.id) && OrgChart.isNEU(n) && OrgChart.isNEU(s.value) && (n = s.id),
                OrgChart.isNEU(s.value) || I.push(`${i.label}: ${s.value}`),
                t += s.html
            }
        }
        return t
    }()}\n\n                                <div class="boc-form-field" style="min-width: 280px; text-align:center; ${w}">\n                                    <a data-add-more-fields-btn href="#" class="boc-link">${s}</a>\n                                </div>\n                            </div>        \n                        </div>\n                    </div>\n                    <div class="boc-form-fieldset" style="padding: 14px 10px; ${_}">\n                        <div class="boc-form-field" style="min-width: initial;">\n                            <button data-edit-from-cancel type="button" class="boc-button transparent">Cancel</button>\n                        </div>\n                        <div class="boc-form-field" style="min-width: initial;">\n                            <button type="submit" data-edit-from-save type="button" class="boc-button">Save and close</button>\n                        </div>\n                    </div>`,
    {
        element: S,
        focusId: n,
        title: u,
...
OrgChart.editUI.prototype.hide = function() {
    if (!1 === OrgChart.events.publish("hide", [this]))
        return !1;
    OrgChart.isNEU(this.interval) && (clearInterval(this.interval),
    this.interval = null);
...
OrgChart.menuUI.prototype._show = function(t, e, r, i, a) {
    ...
    if (!1 === OrgChart.events.publish("show", [this, l]))
        return !1;
    for (var s in a = l.menu) {
        var h = a[s].icon
          , c = a[s].text;
        void 0 === h && (h = OrgChart.icon[s](24, 24, "#7A7A7A")),
        "function" == typeof c && (c = c()),
        "function" == typeof h && (h = h()),
        o += "<div " + OrgChart.attr.item + '="' + s + '">' + h + "<span>&nbsp;&nbsp;" + c + "</span></div>"
    }
    if ("" != o) {
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
            (s = f[u]).addEventListener("click", (function(t) {
                ...
                if (void 0 === a[o].onClick)
                    if ("add" === o) {
                        ...
                        "remove" === o ? n.obj.removeNode(r, null, !0) : "svg" === o ? n.obj.exportSVG({
...
OrgChart.menuUI.prototype.hide = function() {
    null != this.wrapper && (this.obj.element.removeChild(this.wrapper),
    this.wrapper = null)
}
,
    ...
    if (!OrgChart.isNEU(a.nodeCircleMenuButton)) {
        ...
        if (OrgChart.isNEU(p) || p.getAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id) != t) {
            ...
            var f = {
              ...
              , u = OrgChart.events.publish("show", [this, f]);
            if (this._menu = e,
            !1 === u)
                return !1;
            for (var m = 0, C = Object.keys(f.menu).length, b = 2 * a.nodeCircleMenuButton.radius + 4, O = 2 * Math.PI * b, v = O / C - (2 * a.nodeCircleMenuButton.radius + 2); v < 0; )
                b += 8,
                v = (O = 2 * Math.PI * b) / C - (2 * a.nodeCircleMenuButton.radius + 2);
            for (var x in (p = document.createElementNS("http://www.w3.org/2000/svg", "g")).setAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id, t),
            p.setAttribute("transform", "matrix(1,0,0,1," + c + "," + d + ")"),
            n.appendChild(p),
            f.menu) {
                var y = f.menu[x].icon
                  , _ = f.menu[x].color
                ...
                k.setAttribute(OrgChart.attr.control_node_circle_menu_name, x),
                ...
                if (A.setAttribute("pointer-events", "none"),
                A) {
                    var N = parseInt(A.getAttribute("width"))
                      , L = parseInt(A.getAttribute("height"));
                    A.setAttribute("x", -N / 2),
                    A.setAttribute("y", -L / 2)
                }
                var M = m * Math.PI / (C / 2);
                m++;
                var E = Math.cos(M) * b
            ...
            this._linesInterval.push(OrgChart.anim(g[1], {
                x1: -a.nodeCircleMenuButton.radius / 2,
                y1: 0,
                x2: a.nodeCircleMenuButton.radius / 2,
                y2: 0
            ...
            this._linesInterval.push(OrgChart.anim(g[2], {
                x1: -a.nodeCircleMenuButton.radius / 2,
                y1: 6,
                x2: a.nodeCircleMenuButton.radius / 2,
                y2: 6
...
OrgChart.circleMenuUI.prototype.hide = function() {
    ...
    for (t = this._linesInterval.length - 1; t >= 0; t--)
        clearInterval(this._linesInterval[t]),
        this._linesInterval.splice(t, 1);
    this._linesInterval = [];
...
OrgChart.idb._open = function(t) {
    if (OrgChart._browser().msie)
        t && t(!1);
    else if ((navigator.userAgent.toLowerCase().indexOf("safari") > 0 || navigator.userAgent.toLowerCase().indexOf("firefox") > 0) && window.location !== window.parent.location)
        t && t(!1);
    else {
        if (!window.indexedDB)
            return console.error("Your browser doesn't support a stable version of IndexedDB."),
            void (t && t(!1));
        if (null == OrgChart.idb.db) {
            ...
            e.onsuccess = function(e) {
                OrgChart.idb.db = e.target.result,
                t && t(!0)
            }
            ,
...
OrgChart.toolbarUI.prototype.init = function(t, e) {
    if (e) {
        ...
        e.fullScreen && (this.div.innerHTML += "<div " + OrgChart.attr.tlbr + '="fullScreen">' + OrgChart.toolbarUI.openFullScreenIcon + "</div>"),
...
OrgChart.notifierUI.prototype.show = function(t, e) {
    if (null != t) {
        1 == t && (t = OrgChart.MAX_NODES_MESS,
        e = "#FFCA28"),
        2 == t && (t = OrgChart.OFFLINE_MESS,
        e = "#FFCA28");
...
OrgChart.prototype.exportPDF = function(t, e) {
    t = this._defaultExportOptions(t, "pdf"),
    this._export(t, e)
}
,
OrgChart.prototype.exportPNG = function(t, e) {
    t = this._defaultExportOptions(t, "png"),
    this._export(t, e)
}
,
OrgChart.prototype.exportSVG = function(t, e) {
    t = this._defaultExportOptions(t, "svg"),
    this._export(t, e)
}
,
OrgChart.prototype._defaultExportOptions = function(t, e) {
    return null == t && (t = {}),
    "svg" == e ? (t.ext = "svg",
    t.mime = "image/svg+xml") : "pdf" == e ? (t.mime = "application/pdf",
    t.ext = "pdf") : "png" == e && (t.mime = "image/png",
    t.ext = "png"),
    ...
    null == t.mode && (t.mode = this.config.mode),
    t
}
,
OrgChart.prototype._export = function(t, e) {
    ...
    this._draw(!1, OrgChart.action.exporting, i, (function(i) {
        ...
        if ("svg" == t.ext)
            if (e)
                ...
                if (h && (l.styles += h.outerHTML),
                l.styles && (a.childNodes[0].insertAdjacentHTML("afterbegin", l.styles),
                l.content = a.innerHTML),
                !1 === s)
                    return !1;
                if (!1 === (s = OrgChart.events.publish("exportend", [r, l])))
                    return !1;
                OrgChart._downloadFile(t.mime, l.content, l.options.filename, l.options.openInNewTab)
            }
        else
            r._pages(t, a.querySelector("svg"), (function(i) {
                var n = {
                    content: a.innerHTML,
                    options: t,
                    pages: i,
                ...
                if (l && (n.styles += l.outerHTML),
                !1 === o)
                    return !1;
                e || OrgChart.loading.show(r),
                e ? e(r, n, a.querySelector("svg")) : (n = JSON.stringify(n),
                OrgChart._ajax(r.config.exportUrl + "/v3", "POST", n, "arraybuffer", (function(e) {
                    var i = OrgChart.events.publish("exportend", [r, e]);
                    if (OrgChart.loading.hide(r),
                    !1 === i)
                        return !1;
...
OrgChart.prototype.exportCSV = function(t) {
    ...
    if (!1 === OrgChart.events.publish("exportstart", [this, e]))
        return !1;
    ...
    if (!1 === OrgChart.events.publish("exportend", [this, i]))
        return !1;
...
OrgChart.prototype._pagesA100 = function(t, e, r) {
    ...
    e.setAttribute("height", c.h);
    for (var g = c.w * (100 / r), p = c.h * (100 / r), f = o, u = l, m = []; f < s + o; ) {
        for (; u < h + l; ) {
            var C = [f, u, g, p];
            C = C.join(),
            m.push({
...
OrgChart.prototype._defaultExportProfileOptions = function(t, e) {
    return (OrgChart.isNEU(t) || OrgChart.isNEU(t.id)) && console.error("options.id is not defilned"),
    "svg" == e ? (t.ext = "svg",
    t.mime = "image/svg+xml") : "pdf" == e ? (t.mime = "application/pdf",
    t.ext = "pdf") : "png" == e && (t.mime = "image/png",
    t.ext = "png"),
...
OrgChart.prototype._exportProfile = function(t, e) {
    ...
    if (!e) {
        if (!1 === OrgChart.events.publish("exportstart", [r, s]))
            return !1;
    ...
    if (c)
        for (var d = 0; d < c.children.length; d++)
            "style" == c.children[d].nodeName.toLowerCase() && (s.styles += c.children[d].outerHTML);
    s = JSON.stringify(s),
    OrgChart._ajax(this.config.exportUrl + "/v3", "POST", s, "arraybuffer", (function(i) {
        if (e)
            e(r, i);
        else {
            ...
            if (t[e]) {
                ...
                if (i.length > 0) {
                    ...
                    for (a = 0; a < i.length; a++)
                        1 == r.length ? o = i[a](r[0]) && o : 2 == r.length ? o = i[a](r[0], r[1]) && o : 3 == r.length ? o = i[a](r[0], r[1], r[2]) && o : 4 == r.length ? o = i[a](r[0], r[1], r[2], r[3]) && o : 5 == r.length && (o = i[a](r[0], r[1], r[2], r[3], r[4]) && o);
                    return o
                }
            }
        }
    ...
    e.onchange = function(e) {
        ...
        i.onload = function() {
            ...
            OrgChart._importSetColumnNames(n, (function(e) {
                ...
                0 != OrgChart.events.publish("import", [t, h]) && (t.config.nodes = h.nodes,
                t.draw())
            }
            ))
        }
...
OrgChart._importSetColumnNames = function(t, e) {
    if (-1 == t.indexOf("id") || -1 == t.indexOf("pid")) {
        ...
        c.setAttribute("for", "boc-id-select"),
        c.appendChild(d),
        ...
        for (var f = 0; f < t.length; f++) {
            (O = document.createElement("option")).setAttribute("value", t[f]);
            var u = document.createTextNode(t[f]);
            O.appendChild(u),
            g.appendChild(O)
        }
        ...
        document.onmousemove = function(t) {
            t = t || window.event,
            a._dragging && (a.style.left = a._originalLeft + t.clientX - a._mouseLeft + "px",
...
OrgChart._importCenter = function(t) {
    t && (t.style.left = (window.innerWidth - t.offsetWidth) / 2 + "px",
...
OrgChart.prototype.importXML = function() {
    ...
    e.onchange = function(e) {
        ...
        i.onload = function() {
            ...
            0 != OrgChart.events.publish("import", [t, r]) && (t.config.nodes = r,
            t.draw())
        }
        ,
        i.readAsText(r.files[0])
...
OrgChart.prototype.expandCollapseToLevel = function(t, e, r, i) {
    this.config.collapse = e,
    null == r && (r = {}),
    this.config.expand = r;
    var a = {
        id: t,
...
OrgChart.prototype.maximize = function(t, e, r, i) {
    ...
    OrgChart.isNEU(n.id) && (n.id = this.roots[0].id,
    n.all = !0),
...
OrgChart.prototype.minimize = function(t, e) {
    ...
    OrgChart.isNEU(i.id) && (i.id = this.roots[0].id,
    i.all = !0),
...
OrgChart.prototype._expCollHandler = function(t) {
    ...
    if (r.length) {
        ...
        if (!1 === OrgChart.events.publish("expcollclick", [this, !0, t, e.childrenIds]))
            return !1;
...
OrgChart.prototype._upHandler = function(t) {
    ...
    if (!1 === OrgChart.events.publish("up-click", [this, e]))
        return !1;
...
OrgChart.prototype._globalMouseDownHandler = function(t, e) {
    ...
    if (this.config.nodeMouseClick == OrgChart.action.pan) {
        for (var i = e.target; i != t && !i.hasAttribute(OrgChart.attr.control_expcoll_id) && !i.hasAttribute(OrgChart.attr.control_up_id); )
            i = i.parentNode;
        if (!i.hasAttribute(OrgChart.attr.control_expcoll_id) && !i.hasAttribute(OrgChart.attr.control_up_id))
            return e.stopPropagation(),
            e.preventDefault(),
            void this._mouseDownHandler(t, e, r)
    }
...
OrgChart.prototype._globalClickHandler = function(t, e) {
    ...
    } else if (-1 != e.type.indexOf("touch") && null == this._touch)
        return;
    for (var l = e.target; l != t; ) {
        ...
        if (l.hasAttribute(OrgChart.attr.node_id)) {
            s = l.getAttribute(OrgChart.attr.node_id),
            h = this.getNode(s);
        ...
        if (l.hasAttribute(OrgChart.attr.control_up_id)) {
            ...
            return e.stopPropagation(),
            e.preventDefault(),
            void this._upHandler(s)
        }
        if (l.hasAttribute(OrgChart.attr.c_link_from))
            return void OrgChart.events.publish("clink-click", [this, {
        ...
        if (l.hasAttribute(OrgChart.attr.s_link_from))
            return void OrgChart.events.publish("slink-click", [this, {
...
OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function(t, e, r) {
    ...
    if (n.draggable) {
        ...
        var u = OrgChart._getTransform(f)
          , m = u[4]
          , C = u[5]
          , b = function(t) {
            for (; t && !t.hasAttribute(OrgChart.attr.control_node_circle_menu_wrraper_id); )
                t = t.parentNode;
            if (t) {
        ...
        f.setAttribute("transform", "matrix(1,0,0,1," + (m + b.x) + "," + (C + b.y) + ")"),
        f.style.opacity = .7;
        var O = function(t, e) {
            if (null != t) {
          ...
          , v = function(e) {
            if (p) {
                ...
                if (s.left || s.right || s.up || s.down) {
                    g.classList && (g.classList.remove("boc-cursor-grab"),
                    ...
                    for (o.stopMove(),
                    g.classList && (g.classList.add("boc-cursor-grab"),
                    ...
                    if (u[4] = m + E,
                    u[5] = C + P,
                    !t._dragEventFired && (Math.abs(r.x - p.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - p.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                        !1 === OrgChart.events.publish("drag", [o.nodeCircleMenuUI, {
                            from: I,
                            menuItem: n,
                            menuItemName: a
                        }]) && x(),
          ...
          , x = function(e) {
            ...
            g.removeEventListener(r.up, x),
            r.leave && g.removeEventListener(r.leave, x),
            s.id == c || null == c)
                return g.removeChild(f),
                o._gragStartedId = null,
                void (t._dragEventFired && OrgChart.events.publish("drop", [o.nodeCircleMenuUI, {
                    from: s.id,
                    menuItemName: a,
                    menuItem: n
                }]));
        ...
        g.addEventListener(r.up, x),
        r.leave && g.addEventListener(r.leave, x)
    }
}
,
    ...
    if (this.config.enableDragDrop) {
        ...
        var m = function(t, e) {
          ...
          , C = function(e) {
            if (c) {
                ...
                if (C.left || C.right || C.up || C.down) {
                    h.classList && (h.classList.remove("boc-cursor-grab"),
                    ...
                    s.startMove(C, (function(t) {
                        d[4] = O + t.x,
                        d[5] = v + t.y,
                        c.x = x - t.xWithoutScale,
                        c.y = y - t.yWithoutScale,
                        r.x = _ - t.xWithoutScale,
                        r.y = w - t.yWithoutScale,
                        u.setAttribute("transform", "matrix(" + d.toString() + ")")
                    }
                    ))
                } else {
                    if (s.stopMove(),
                    h.classList && (h.classList.add("boc-cursor-grab"),
                    ...
                    if (null != o) {
                        ...
                        !s._canUpdateLink(n.id, o) && h.classList ? (h.classList.remove("boc-cursor-grab"),
                        h.classList.remove("boc-cursor-move"),
                        h.classList.remove("boc-cursor-copy"),
                        h.classList.add("boc-cursor-nodrop")) : h.classList && (h.classList.remove("boc-cursor-grab"),
                        h.classList.remove("boc-cursor-move"),
                    ...
                    if (d[4] = g + L,
                    d[5] = p + M,
                    !t._dragEventFired && (Math.abs(r.x - c.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(r.y - c.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                        !1 === OrgChart.events.publish("drag", [s, k]) && b(),
                        t._dragEventFired = !0;
                    u.setAttribute("transform", "matrix(" + d.toString() + ")")
                }
            }
          ...
          , b = function(e) {
            ...
            h.removeEventListener(r.up, b),
            r.leave && h.removeEventListener(r.leave, b),
            n.id == o || null == o)
                return h.removeChild(u),
                s._gragStartedId = null,
                void (t._dragEventFired && OrgChart.events.publish("drop", [s, n.id]));
            var i = s.getNode(o);
            if (!1 === OrgChart.events.publish("drop", [s, n.id, i.id]))
                return m(o, l),
                h.removeChild(u),
        ...
        h.addEventListener(r.up, b),
        r.leave && h.addEventListener(r.leave, b)
    }
}
,
...
OrgChart.prototype._commonClickHandler = function(t, e, r) {
    ...
    r == OrgChart.action.edit) && ((i = this.getNode(t)) && (this.editUI.show(i.id),
    this.ripple(i.id, e.clientX, e.clientY)));
    r == OrgChart.action.details && ((i = this.getNode(t)) && (this.editUI.show(i.id, !0),
    this.ripple(i.id, e.clientX, e.clientY)))
}
,
...
OrgChart.prototype.toggleExpandCollapse = function(t, e) {
    ...
    if (i.length) {
        ...
        if (!1 === OrgChart.events.publish("expcollclick", [this, !0, t, r.childrenIds]))
            return !1;
    ...
    if (t) {
        ...
        !this._moveInterval) {
            ...
            this._moveInterval = setInterval((function() {
                ...
                r._movePosition.left && (n++,
                t.x = n * OrgChart.MOVE_STEP / a,
                t.xWithoutScale = n * OrgChart.MOVE_STEP),
                r._movePosition.right && (n++,
                t.x = -n * OrgChart.MOVE_STEP / a,
                t.xWithoutScale = -n * OrgChart.MOVE_STEP),
                r._movePosition.up && (o++,
                t.y = -o * OrgChart.MOVE_STEP / a,
                t.yWithoutScale = -o * OrgChart.MOVE_STEP),
                r._movePosition.down && (o++,
                t.y = o * OrgChart.MOVE_STEP / a,
                t.yWithoutScale = o * OrgChart.MOVE_STEP),
...
OrgChart.prototype.stopMove = function() {
    this._moveInterval && (clearInterval(this._moveInterval),
    this._moveInterval = null,
    this._movePosition = null)
}
,
...
OrgChart.prototype._mouseDownHandler = function(t, e, r) {
    ...
    e.touches && e.touches.length > 1 && (s.type = "pinch",
    s.dist = Math.sqrt((o.x - l.x) * (o.x - l.x) + (o.y - l.y) * (o.y - l.y)));
    var h = this.getPointerElement();
    if ("pan" == s.type) {
        this._hideBeforeAnimation();
        var c = OrgChart._getOffsetXY(this.element, e)
          , d = c.x / n + a[0] - 16 / n
          , g = c.y / n + a[1] - 16 / n;
        h.style.display = "inherit",
        h.setAttribute("transform", "matrix(0,0,0,0," + d + "," + g + ")"),
        OrgChart.anim(h, {
            transform: [0, 0, 0, 0, d, g],
            opacity: 0
        }, {
            transform: [1 / n, 0, 0, 1 / n, d, g],
            opacity: 1
    ...
    var p = function(t) {
      ...
      , f = function() {
        ...
        ), 0) : "pan" != s.type || i.config.sticky || i._draw(!0, OrgChart.action.pan),
        s = null,
...
OrgChart.searchUI.prototype.init = function(t) {
    ...
    r.classList.add("boc-search"),
    r.style.right = this.obj.config.padding - 10 + "px",
    r.style.top = this.obj.config.padding - 10 + "px";
    var i = OrgChart.elements.textbox({}, {
        label: OrgChart.SEARCH_PLACEHOLDER
    }, "320px");
    r.innerHTML += i.html,
    this.searchTableWrapper = document.createElement("div"),
    r.appendChild(this.searchTableWrapper);
    var a = t.getSvg().nextSibling;
    this.obj.element.insertBefore(r, a),
    OrgChart.input.init(r),
    this.input = document.getElementById(i.id),
    ...
    this.input.addEventListener("keyup", (function(t) {
        ...
        n()) : "ArrowUp" == t.key ? (t.preventDefault(),
        t.stopPropagation(),
        o()) : "Enter" == t.key ? (t.preventDefault(),
        l()) : "Escape" == t.key ? (t.preventDefault(),
        e.hide()) : e._serverSearch(this.value)
    }
    ));
    var n = function() {
        var t = e.obj.element.querySelectorAll("[data-search-item-id]")
          , r = e.obj.element.querySelector('[data-selected="yes"]');
        null == r && t.length > 0 ? t[0].setAttribute("data-selected", "yes") : t.length > 0 && r.nextSibling && r.nextSibling.setAttribute && (r.removeAttribute("data-selected"),
        r.nextSibling.setAttribute("data-selected", "yes"))
    }
      , o = function() {
        var t = e.obj.element.querySelectorAll("[data-search-item-id]")
          , r = e.obj.element.querySelector('[data-selected="yes"]');
        null == r && t.length > 0 ? t[t.length - 1].setAttribute("data-selected", "yes") : t.length > 0 && r.previousSibling && r.previousSibling.setAttribute && (r.removeAttribute("data-selected"),
    ...
    var e = this
      ...
      , a = `<table border="0" cellspacing="0" cellpadding="0">\n                    <tbody>\n                        ${function() {
        for (var t = "", a = 0; a < r.length && !(a >= OrgChart.SEARCH_RESULT_LIMIT); a++) {
            ...
            var s = ""
              , h = "";
            e.obj.config.searchDisplayField == n.__searchField ? s = n.__searchMarks : e.obj.config.searchDisplayField ? (s = n[e.obj.config.searchDisplayField],
            OrgChart.isNEU(s) && (s = ""),
            h = n.__searchMarks) : s = n.__searchMarks,
            t += OrgChart.searchUI.createItem(o, n.id, s, h)
        }
        return t
    }()}  \n                    </tbody>\n                </table>`;
    this.searchTableWrapper.innerHTML = a;
    for (var n = this.obj.element.querySelectorAll("[data-search-item-id]"), o = 0; o < n.length; o++)
        n[o].addEventListener("click", (function() {
            if (!1 !== OrgChart.events.publish("searchclick", [e.obj, this.getAttribute("data-search-item-id")])) {
                ...
                var t = e.obj.element.querySelector('[data-selected="yes"]');
                t && t.removeAttribute("data-selected"),
...
OrgChart.manager.prototype.read = function(t, e, r, i, a, n, o, l) {
    ...
    OrgChart.state._get(this.config.state, e, r, (function(h) {
        ...
        s.action = a,
        s.actionParams = n,
        a != OrgChart.action.init || !s.state || n && n.method && "fit" == n.method ? (s.viewBox = i,
        s.vbIsInitializedFromState = !1) : (s.viewBox = s.state.vb,
        ...
        var c = s.maxX
          ...
          , m = s.nodes;
        if (t) {
            var C = OrgChart.manager._getResponse(e, r, s.visibleNodeIds, s.config, c, d, g, p, s.viewBox, u, s.action, s.actionParams, m, s.oldNodes, s.vbIsInitializedFromState);
            a != OrgChart.action.exporting && (s.maxX = c,
            s.maxY = d,
            s.minX = g,
            s.minY = p,
            s.roots = u,
            ...
            s._read((function(t) {
                ...
                g = t.minX,
                p = t.minY,
                f = t.bordersByRootIdAndLevel,
                u = t.roots,
                m = t.nodes;
                var i = OrgChart.manager._getResponse(e, r, s.visibleNodeIds, s.config, c, d, g, p, s.viewBox, u, s.action, s.actionParams, m, s.oldNodes, s.vbIsInitializedFromState);
                i.notif = t.limit,
                i.roots = u,
                i.bordersByRootIdAndLevel = f,
...
OrgChart.manager.prototype._read = function(t, e) {
    ...
    o._setPositions(n, r.layoutConfigs, (function(e) {
        ...
        for (var l = {
            ...
            OrgChart.manager._setMinMaxXYAdjustifyIterate(n[h], n[h], l, 0, s, o, r.config.orientation);
        t({
            minX: l.minX,
            minY: l.minY,
            maxX: l.maxX,
...
OrgChart.manager._setCollpasedProperty = function(t, e, r, i, a, n, o) {
    null == t.collapsed && e.collapse && e.collapse.allChildren ? t.collapsed = !0 : null == t.collapsed && (t.collapsed = !1),
    a == OrgChart.action.expand && -1 != r.ids.indexOf(t.id) && (t.collapsed = !1),
    a == OrgChart.action.collapse && (r.expandIds || r.collapseIds) ? r.expandIds && -1 != r.expandIds.indexOf(t.id) ? t.collapsed = !1 : r.collapseIds && -1 != r.collapseIds.indexOf(t.id) && (t.collapsed = !0) : a == OrgChart.action.collapse && -1 != r.ids.indexOf(t.id) && (t.collapsed = !0),
    a == OrgChart.action.expand && "all" == r.ids && (t.collapsed = !1),
    a == OrgChart.action.exporting && r.expandChildren && (t.collapsed = !1),
    a == OrgChart.action.init && null != o ? t.collapsed = !o.exp.has(t.id) : a == OrgChart.action.init ? t.collapsed = e.collapse && n >= e.collapse.level - 1 && -1 == i.indexOf(t.id) : a != OrgChart.action.centerNode && a != OrgChart.action.insert && a != OrgChart.action.expand && a != OrgChart.action.collapse || i.has(t.id) && (t.collapsed = !1)
}
,
OrgChart.manager._initNode = function(t, e, r, i, a, n, o, l, s, h, c) {
    var d = n[r || "base"];
    null == t.parent && OrgChart.manager._setCollpasedProperty(t, d, s, l, a, i - 1, c);
    for (var g = 0; g < t.childrenIds.length; g++) {
        var p = e[t.childrenIds[g]];
        if (OrgChart.manager._setCollpasedProperty(p, d, s, l, a, i, c),
        !p.collapsed) {
            if (p.parent = t,
            null != p.ppid) {
                var f = e[p.ppid];
            ...
            (-1 != p.tags.indexOf("left-partner") || -1 != p.tags.indexOf("right-partner") || -1 != p.tags.indexOf("partner") || p.parentPartner) && -1 == h.indexOf(t.id) && h.push(t.id),
            t.children.push(p)
        }
    }
    if (t.min || a != OrgChart.action.minimize || (s.all || s.id == t.id) && (t.min = !0),
    !0 === t.min && a == OrgChart.action.maximize && (s.all || s.id == t.id) && (t.min = !1),
    a == OrgChart.action.init && null != c && (t.min = c.min.has(t.id)),
    !t.min)
        for (g = 0; g < t.stChildrenIds.length; g++) {
            (p = e[t.stChildrenIds[g]]).stParent = t,
            t.stChildren.push(p)
        }
    var u = OrgChart.t(t.templateName, t.min);
    t.w = u && u.size ? u.size[0] : 0,
    t.h = u && u.size ? u.size[1] : 0,
    t.padding = u && u.padding ? u.padding : [0, 0, 0, 0],
    null != i && (t.level = i),
    r && (t.lcn = r);
    var m = OrgChart._getSubLevels(t.tags, o.tags);
    m > 0 && (t.subLevels = m),
    -1 != t.tags.indexOf("assistant") && null != t.parent && (t.isAssistant = !0),
    OrgChart.events.publish("node-created", [t])
}
,
OrgChart.manager._iterate = function(t, e, r, i, a, n, o, l, s, h, c, d, g, p, f, u) {
    if (OrgChart.manager._initNode(e, r, s, i, d, h, c, g, p, f, u),
    e.isAssistant && (n[e.pid] || (n[e.pid] = []),
    n[e.pid].push(e.id)),
    e.subLevels > 0 && o.push(e.id),
    OrgChart.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !e.isAssistant && e.parent) {
        if (e.parent && e.parent.children.length && e.parent.children[e.parent.children.length - 1] == e) {
            for (var m = [], C = 0, b = 0, O = 0; O < e.parent.children.length; O++) {
                -1 == (v = e.parent.children[O]).tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") && -1 == v.tags.indexOf("assistant") && 0 == v.children.length ? m.push(v.id) : -1 != v.tags.indexOf("assistant") ? C++ : -1 == v.tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") || b++
            }
            (OrgChart.MIXED_LAYOUT_ALL_NODES && m.length > 1 && m.length == e.parent.children.length - C - b || !OrgChart.MIXED_LAYOUT_ALL_NODES && m.length > 1) && (l[e.pid] = m)
        }
    } else if (!e.isAssistant && 0 == e.childrenIds.length && e.parent && !l[e.pid]) {
        for (m = [],
        C = 0,
        b = 0,
        O = 0; O < e.parent.children.length; O++) {
            var v;
            -1 == (v = e.parent.children[O]).tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") && -1 == v.tags.indexOf("assistant") && 0 == v.childrenIds.length ? m.push(v.id) : -1 != v.tags.indexOf("assistant") ? C++ : -1 == v.tags.indexOf("partner") && -1 == v.tags.indexOf("left-partner") && -1 == v.tags.indexOf("right-partner") || b++
        }
        (OrgChart.MIXED_LAYOUT_ALL_NODES && m.length > 1 && m.length == e.parent.childrenIds.length - C - b || !OrgChart.MIXED_LAYOUT_ALL_NODES && m.length > 1) && (l[e.pid] = m)
    }
    e.stChildren.length && (t.stContainerNodes || (t.stContainerNodes = []),
    t.stContainerNodes.push(e));
    for (var x = 0; x < e.stChildren.length; x++) {
        var y = "";
        for (O = 0; O < e.tags.length; O++)
            if (h[e.tags[O]]) {
                y = e.tags[O];
                break
            }
        a.push(e.stChildren[x].id),
        OrgChart.manager._iterate(t, e.stChildren[x], r, 0, a, n, o, l, y, h, c, d, g, p, f, u)
    }
    i++;
    for (x = 0; x < e.children.length; x++)
        OrgChart.manager._iterate(t, e.children[x], r, i, a, n, o, l, s, h, c, d, g, p, f, u)
}
,
OrgChart.manager.__createNodes = function(t, e, r, i, a, n, o) {
    for (var l = r.nodes, s = [], h = 0; h < l.length; h++) {
        var c, d = l[h];
        c = OrgChart.STRING_TAGS ? d.tags ? d.tags.split(",") : [] : Array.isArray(d.tags) ? d.tags.slice(0) : [];
        var g = OrgChart._getTemplate(c, r.tags, r.template)
          , p = new OrgChart.node(d.id,d.pid,c,g);
        OrgChart.isNEU(d.ppid) || (p.ppid = d.ppid),
        OrgChart.isNEU(d.stpid) || (p.stpid = d.stpid),
        null != r.orderBy && (p.order = OrgChart.manager._getOrderFieldValue(d, r.orderBy)),
        t[d.id] = p,
        s.push(d.id)
    }
    null != r.orderBy && s.sort((function(e, i) {
        var a = t[e].order
          , n = t[i].order;
        return "number" == typeof a || "number" == typeof n ? (null == a && (a = -1),
        null == n && (n = -1),
        r.orderBy.desc ? n - a : a - n) : "string" == typeof a || "string" == typeof n ? (null == a && (a = ""),
        null == n && (n = ""),
        r.orderBy.desc ? n.localeCompare(a) : a.localeCompare(n)) : void 0
    }
    ));
    for (h = 0; h < s.length; h++) {
        ...
        m) {
            var b = n ? n[m.id] : null;
            b && (m.min = b.min),
            m.stChildrenIds.push(p.id)
        } else
            C ? (u && (p.collapsed = u.collapsed,
            p.min = u.min),
            C.childrenIds.push(p.id)) : (u && (p.collapsed = u.collapsed,
            p.min = u.min),
            e.push(p),
            o.push(p.id));
...
OrgChart.manager._createNodes = function(t, e, r, i, a, n) {
    var o = {}
      , l = []
      , s = [];
    if (OrgChart.manager.__createNodes(o, l, t, r, i, a, s),
    null != t.roots) {
        l = [];
        for (var h = 0; h < t.roots.length; h++) {
            var c = o[t.roots[h]];
            if (c && r == OrgChart.action.centerNode) {
                for (var d = c; null != d.pid || null != d.stpid; )
                    d = null == d.pid && null != d.stpid ? o[d.stpid] : o[d.pid];
                for (var g = o[i.id]; null != g.pid || null != g.stpid; )
                    g = null == g.pid && null != g.stpid ? o[g.stpid] : o[g.pid];
                d == g && (c = d)
            }
            if (c) {
                ...
                if (!p) {
                    if (!OrgChart.isNEU(c.pid))
                        (H = (b = o[c.pid]).childrenIds.indexOf(c.id)) > -1 && b.childrenIds.splice(H, 1);
                    l.push(c)
                }
            }
        }
    ...
    r == OrgChart.action.exporting && null != i.id && ((m = o[i.id]) && (m.pid = null,
    l = [m]));
    var u = [];
    if (r == OrgChart.action.init && t.expand && t.expand.nodes && null == n)
        for (h = 0; h < t.expand.nodes.length; h++) {
            var m = o[t.expand.nodes[h]];
            for (!0 === t.expand.allChildren && OrgChart.manager._addExpandedNodeIdsIterate(m, o, u); m; )
                u.push(m.id),
                null == m.pid && null != m.stpid ? (m = o[m.stpid]).min = !1 : m = o[m.pid]
        }
        ...
        for (h = 0; h < C.length; h++)
            for (var b = o[(m = o[C[h]]).pid]; b; )
                u.push(b.id),
                null == b.pid && null != b.stpid ? (b = o[b.stpid]).min = !1 : b = o[b.pid]
    } else if (r == OrgChart.action.centerNode) {
        for (var O = o[i.id]; O; ) {
            if (u.push(O.id),
            i.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && O)
                for (h = 0; h < O.childrenIds.length; h++) {
                    (U = o[O.childrenIds[h]]).collapsed = !0
                }
            null == O.pid && null != O.stpid ? (O = o[O.stpid]).min = !1 : O = o[O.pid]
        }
        O = o[i.id];
        if (i.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
            for (h = 0; h < O.childrenIds.length; h++) {
                (x = o[O.childrenIds[h]]).collapsed = !1;
                for (var v = 0; v < x.childrenIds.length; v++) {
                    o[x.childrenIds[v]].collapsed = !0
                }
            }
        if (i.options.parentState === OrgChart.COLLAPSE_PARENT_SUB_CHILDREN_EXCEPT_CLICKED)
            if (b = o[O.pid])
                for (h = 0; h < b.childrenIds.length; h++) {
                    var x;
                    if ((x = o[b.childrenIds[h]]) != O) {
                        x.collapsed = !1;
                        for (v = 0; v < x.childrenIds.length; v++) {
                            o[x.childrenIds[v]].collapsed = !0
                        }
                    }
                }
    } else if (r == OrgChart.action.insert)
        for (m = o[i.insertedNodeId]; m; )
            u.push(m.id),
            null == m.pid && null != m.stpid ? (m = o[m.stpid]).min = !1 : m = o[m.pid];
    var y = []
      , _ = {}
      ...
      , S = [];
    for (h = 0; h < l.length; h++)
        OrgChart.manager._iterate(l[h], l[h], o, 0, y, _, w, k, "", e, t, r, u, i, S, n);
    for (h = l.length - 1; h >= 0; h--)
        l[h].collapsed && l.splice(h, 1);
    for (h = 0; h < S.length; h++) {
        m = o[S[h]];
        var I = []
          , A = []
        ...
        for (v = 0; v < m.children.length; v++) {
            (U = m.children[v]).isAssistant ? I.push(U.id) : -1 != U.tags.indexOf("right-partner") ? (U.isPartner = 1,
            U.children = [],
            A.push(U.id)) : -1 != U.tags.indexOf("left-partner") ? (U.isPartner = 2,
            U.children = [],
            N.push(U.id)) : -1 == U.tags.indexOf("partner") || M % 2 ? -1 != U.tags.indexOf("partner") && M % 2 ? (U.isPartner = 2,
            U.children = [],
            N.push(U.id),
            M++) : U.parentPartner ? (L[U.parentPartner.id] || (L[U.parentPartner.id] = []),
            L[U.parentPartner.id].push(U.id)) : I.push(U.id) : (U.isPartner = 1,
            U.children = [],
            A.push(U.id),
            M++)
        }
        ...
        for (v = 0; v < A.length; v++) {
            L[(U = o[A[v]]).id] ? m.children.push(U) : m.children.splice(0, 0, U)
        }
        for (v = 0; v < N.length; v++) {
            L[(U = o[N[v]]).id] ? m.children.push(U) : m.children.splice(0, 0, U)
        }
        for (v = N.length - 1; v >= 0; v--)
            if (L[N[v]])
                for (f = 0; f < L[N[v]].length; f++)
                    m.children.push(o[L[N[v]][f]]),
                    E++,
                    -1 == B.indexOf(N[v]) && B.push(N[v]);
        ...
        for (v = 0; v < A.length; v++)
            if (L[A[v]])
                for (f = 0; f < L[A[v]].length; f++)
                    m.children.push(o[L[A[v]][f]]),
                    P++,
                    -1 == T.indexOf(A[v]) && T.push(A[v]);
        m.partnerSeparation = Math.max(B.length, T.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation,
        I.length || !E || P ? I.length || E || !P ? I.length || 1 != E || 1 != P ? I.length || E || P ? !I.length || E || P ? I.length && (E || P) ? m.hasPartners = 7 : m.hasPartners = 1 : m.hasPartners = 6 : m.hasPartners = 5 : m.hasPartners = 4 : m.hasPartners = 3 : m.hasPartners = 2
    }
    for (h = 0; h < w.length; h++) {
        if ((Z = e[(m = o[w[h]]).lcn ? m.lcn : "base"]).layout == OrgChart.normal || !k[m.pid])
            for (v = 0; v < m.subLevels; v++) {
                var H, z = new OrgChart.node(m.id + "_sub_level_index_" + v,m.pid,[],"subLevel");
                if (OrgChart.manager._initDinamicNode(z, m.lcn),
                b = m.parent)
                    (H = b.children.indexOf(m)) > -1 && (b.children.splice(H, 1),
                    b.children.splice(H, 0, z)),
                    z.children.push(m),
                    z.parent = b,
                    m.parent = z,
                    o[z.id] = z
    ...
    for (var F in _) {
        (b = o[F]).hasAssistants = !0;
        z = new OrgChart.node(b.id + "_split_assitant_0",b.id,["assistant"],"split");
        OrgChart.manager._initDinamicNode(z, b.lcn, !0),
        o[z.id] = z;
        var j = [];
        for (v = b.children.length - 1; v >= 0; v--) {
            (U = b.children[v]).isAssistant ? (U.parent = null,
            b.children.splice(v, 1),
            j.splice(0, 0, U.id)) : U.isPartner || (U.parent && k[U.parent.id] && z && U.parent.id != z.id && (Object.defineProperty(k, z.id, Object.getOwnPropertyDescriptor(k, U.parent.id)),
        ...
        if (j.length % 2) {
            ...
            OrgChart.manager._initDinamicNode(D, R.lcn, !0),
            R._m = D.id,
            D.isAssistant = !0,
            D.w = R.w,
            D.h = R.h,
            o[D.id] = D,
            j.splice(j.length - 1, 0, D.id)
        }
        var Y = 1;
        for (v = j.length - 1; v >= 0; v--)
            if (v % 2 && v != j.length - 1) {
                var X = new OrgChart.node(b.id + "_split_assitant_" + Y,null,[],"split");
                OrgChart.manager._initDinamicNode(X, b.lcn, !0),
                o[X.id] = X,
                j.splice(v, 0, X.id),
                Y++
            } else
                v % 2 && j.splice(v, 0, z.id);
        for (v = 0; v < j.length; v += 3) {
            var q = null;
            q = 0 == v ? b : o[j[v - 2]];
            var V = o[j[v]]
              , $ = o[j[v + 1]]
    ...
    if (G) {
        ...
        for (var F in k) {
            var Z;
            if ((Z = e[(b = o[F]).lcn ? b.lcn : "base"]).layout == OrgChart.mixed || Z.layout == OrgChart.tree || Z.layout == OrgChart.treeRightOffset || Z.layout == OrgChart.treeLeftOffset)
                if (J.pnode = b,
                J.layout = Z.layout,
                J.childrenIds = k[F],
                J.lastChildrenPidIds = k,
                OrgChart.events.publish("layout", [J]),
                J.layout == OrgChart.mixed) {
                    var Q = J.childrenIds;
                    ...
                    z = new OrgChart.node(b.id + "_split_0",b.id,[],"split");
                    OrgChart.manager._initDinamicNode(z, b.lcn),
                    o[z.id] = z,
                    z.layout = OrgChart.tree;
                    var et = [];
                    for (h = J.childrenIds.length - 1; h >= 0; h--) {
                        for (U = o[J.childrenIds[h]],
                        v = 0; v < b.children.length; v++)
                            b.children[v].id == U.id && b.children.splice(v, 1);
                        if (U.parent = null,
                        U.layout = OrgChart.tree,
                        J.layout == OrgChart.treeRightOffset && et.splice(0, 0, U.id),
                        J.layout == OrgChart.treeLeftOffset || J.layout == OrgChart.treeRightOffset) {
                            var rt = new OrgChart.node(U.id + "_mirror",null,[],"mirror");
                            OrgChart.manager._initDinamicNode(rt, U.lcn),
                    ...
                    for (Y = 1,
                    v = et.length - 1; v >= 0; v--)
                        if (v % 2 && v != et.length - 1) {
                            X = new OrgChart.node(b.id + "_split_" + Y,null,[],"split");
                            OrgChart.manager._initDinamicNode(X, b.lcn),
                            X.layout = OrgChart.tree,
                            o[X.id] = X,
                            et.splice(v, 0, X.id),
                            Y++
                        } else
                            v % 2 && et.splice(v, 0, z.id);
                    for (v = 0; v < et.length; v += 3) {
                        q = null;
                        0 == v && (q = b);
                        V = o[et[v]],
                        $ = o[et[v + 1]],
...
OrgChart.manager.getAllFields = function(t) {
    ...
    for (var r in t.nodeBinding)
        e.push(t.nodeBinding[r]);
    for (r = 0; r < t.nodes.length; r++)
        for (var i in t.nodes[r])
            i !== OrgChart.ID && i !== OrgChart.TAGS && i !== OrgChart.NODES && i !== OrgChart.PID && i !== OrgChart.STPID && (t.nodeBinding[i] || e.has(i) || e.push(i));
    return e
}
,
...
,
OrgChart.manager._getResponse = function(t, e, r, i, a, n, o, l, s, h, c, d, g, p, f) {
    var u = h[0]
      , m = []
      , C = {
        top: null,
    ...
    if (C.top = l - i.padding,
    C.left = o - i.padding,
    C.bottom = n + i.padding - e / x,
    C.right = a + i.padding - t / x,
    C.maxX = a,
    C.minX = o,
    C.maxY = n,
    C.minY = l,
    0 == h.length || null == s && !f && i.align == OrgChart.CENTER) {
        var y = Math.ceil(t / x)
          , _ = Math.ceil(e / x)
          , w = 0
          , k = 0;
        if (y - 2 * i.padding >= a - o)
            switch (w = (a + o) / 2 - y / 2,
            i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
            ...
            switch (w = u.x - y / 2 + OrgChart.manager._getNodeWidth(u, i) / 2,
            i.orientation) {
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
        ...
        if (_ - 2 * i.padding >= n - l)
            ...
            switch ((k = -(_ / 2 - (n - l) / 2)) > -i.padding && (k = -i.padding),
            i.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
            ...
            case OrgChart.orientation.left:
            case OrgChart.orientation.right:
                k = u.y - _ / 2 + OrgChart.manager._getNodeWidth(u, i) / 2
            }
        s = [w, k, y, _]
        ...
        case OrgChart.orientation.top:
            w = u.x - y / 2 + OrgChart.manager._getNodeWidth(u, i) / 2,
            k = -i.padding;
            break;
        case OrgChart.orientation.bottom:
            w = u.x - y / 2 + OrgChart.manager._getNodeWidth(u, i) / 2,
        ...
        s = [w, k, y, _],
        i.sticky && (s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left),
        s[0] > C.right && s[0] > C.left && (s[0] = C.left > C.right ? C.left : C.right),
        s[1] < C.top && s[1] < C.bottom && (s[1] = C.top > C.bottom ? C.bottom : C.top),
        s[1] > C.bottom && s[1] > C.top && (s[1] = C.top > C.bottom ? C.top : C.bottom))
    }
    if (c == OrgChart.action.centerNode || c == OrgChart.action.maximize) {
        var S = g[d.id];
        1 == d.options.horizontal && (s[0] = S.x + S.w / 2 - s[2] / 2),
        1 == d.options.vertical && (s[1] = S.y + S.h / 2 - s[3] / 2),
        i.sticky && (s[0] < C.left && s[0] < C.right && (s[0] = C.left > C.right ? C.right : C.left),
        s[0] > C.right && s[0] > C.left && (s[0] = C.left > C.right ? C.left : C.right),
        s[1] < C.top && s[1] < C.bottom && (s[1] = C.top > C.bottom ? C.bottom : C.top),
        s[1] > C.bottom && s[1] > C.top && (s[1] = C.top > C.bottom ? C.top : C.bottom))
    ...
    if (c == OrgChart.action.insert || c == OrgChart.action.expand || c == OrgChart.action.collapse || c == OrgChart.action.update || c == OrgChart.action.centerNode || c == OrgChart.action.maximize) {
        var I = null;
        if (c == OrgChart.action.insert && d && null != d.insertedNodeId && null != d.insertedNodeId)
            I = g[d.insertedNodeId];
        else if (c == OrgChart.action.update && d && null != d.visId && null != d.visId)
            I = g[d.visId];
            ...
            I = g[d.id],
            I = OrgChart.manager._getMostDeepChild(I, g);
    ...
    for (var N = 0; N < h.length; N++)
        OrgChart.manager._iterate2(h[N], g, i, s, c, d, m, p, r, b);
    return {
        animations: b,
        boundary: C,
        viewBox: s,
    ...
    if (OrgChart.manager._isVisible(t, r, i, a)) {
        ...
        if ((a == OrgChart.action.expand || a == OrgChart.action.collapse || a == OrgChart.action.maximize) && l && l[t.id] && "expandCollapseToLevel" == n.method) {
            ...
            f) {
                ...
                for (var d = t, g = null; null != d; )
                    l[d.id] && l[d.id].collapsed && (g = d),
                    d = d.parent;
                g && g.parent && (c = {
                    x: g.parent.x,
                    y: g.parent.y
            ...
            if (u = e[n.id]) {
                for (d = t.parent; null != d && -1 == n.ids.indexOf(t.id) && -1 == n.ids.indexOf(d.id); )
                    d = d.parent;
                d && (c = {
                    x: u.x + u.w / 2 - t.w / 2,
                    y: u.y + u.h / 2 - t.h / 2
            ...
            if (null != (f = l[t.id]).x && null != f.y && (c = {
                x: f.x,
                y: f.y
            }),
            (p = e[n.id]) && p == t)
                (d = t.parent) && d.id == n.id && (c = {
                    x: p.x + p.w / 2 - t.w / 2,
                    y: p.y + p.h / 2 - t.h / 2
                })
        ...
        } else if (a == OrgChart.action.insert && n && n.insertedNodeId == t.id && t.parent)
            c = {
                x: t.parent.x,
                y: t.parent.y
            };
        else if (a != OrgChart.action.update && a != OrgChart.action.insert || !l)
            a !== OrgChart.action.exporting && a !== OrgChart.action.init && -1 == s.indexOf(t.id) && (h[0].push(t.id),
            h[1].push({
                opacity: 0
            }),
            h[2].push({
            ...
            var f, u;
            if ((!(f = l[t.id]) || OrgChart.isNEU(f.x) && OrgChart.isNEU(f.y)) && n) {
                if (u = e[n.id]) {
                    for (d = u; d && d.id == t.id; )
                        d = d.parent;
                    d && (c = {
        ...
        null != c && null != c.x && null != c.y && (c.x == t.x && c.y == t.y || (h[0].push(t.id),
        h[1].push({
...
OrgChart.manager._setMinMaxXYAdjustifyIterate = function(t, e, r, i, a, n, o) {
    ...
    for (var l = 0; l < t.stChildren.length; l++)
        OrgChart.manager._setMinMaxXYAdjustifyIterate(t.stChildren[l], t.stChildren[l], r, 0, a, n, o);
    t.isPartner ? t.sl = i - 1 : t.sl = i,
    null == a[e.id] && (a[e.id] = {}),
    null == a[e.id][t.sl] && (a[e.id][t.sl] = {
        minX: null,
        minY: null,
        maxX: null,
        maxY: null
    ...
    for (l = 0; l < t.children.length; l++)
        OrgChart.manager._setMinMaxXYAdjustifyIterate(t.children[l], e, r, i, a, n, o)
}
,
...
OrgChart.templates.deborah.nodeMenuButton = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,125,130)" ' + OrgChart.attr.control_node_menu_id + '="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#ffffff"></circle><circle cx="7" cy="0" r="2" fill="#ffffff"></circle><circle cx="14" cy="0" r="2" fill="#ffffff"></circle></g>',
...
OrgChart.ui = {
    ...
    defs: function(t) {
        ...
        for (var r in OrgChart.templates) {
            ...
            i.defs && (OrgChart.ui._defsIds[r] = OrgChart.randomId(),
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        c.defs && (d = d.replaceAll("{randId}", OrgChart.ui._defsIds[t.templateName])),
        ...
        for (var p in o) {
            var f, u = o[p];
            if (e && (f = e[u]),
            "function" == typeof u && (f = u(h, t, e)),
            g.value = f,
            g.element = c[p],
            g.name = u,
            !1 !== OrgChart.events.publish("field", [h, g]))
                if (null != g.value && null != g.value && null != g.element)
                    OrgChart._lblIsImg(i, p) || "string" != typeof g.value || (g.value = OrgChart.wrapText(g.value, g.element)),
                    d += g.element.replace("{val}", (function() {
                        return g.value
                    }
        ...
        var m = OrgChart._getPosition(r, t, a, n)
          , C = "node";
        Array.isArray(t.tags) && t.tags.length && (C += " " + t.tags.join(" ")),
        t.layout && (C += " tree-layout");
        var b = "";
        t.lcn && (b = 'lcn="' + t.lcn + '"');
    ...
    nodeBtns: function(t, e, r, i, a) {
        var n = "";
        return null == t.nodeMenu || e.isSplit || r === OrgChart.action.exporting || (n += i.nodeMenuButton.replace("{id}", e.id).replace("{cw}", e.w / 2).replace("{ew}", e.w - (e.padding ? e.padding[1] : 0))),
        null == t.nodeCircleMenu || e.isSplit || r === OrgChart.action.exporting || OrgChart.isNEU(i.nodeCircleMenuButton) || (n += '<g style="cursor:pointer;" transform="matrix(1,0,0,1,' + i.nodeCircleMenuButton.x + "," + i.nodeCircleMenuButton.y + ')" ' + OrgChart.attr.control_node_circle_menu_id + '="' + e.id + '"><circle cx="0" cy="0" fill="' + i.nodeCircleMenuButton.color + '" r="' + i.nodeCircleMenuButton.radius + '" stroke-width="1" stroke="' + i.nodeCircleMenuButton.stroke + '"></circle><line x1="-' + i.nodeCircleMenuButton.radius / 2 + '" y1="-6" x2="' + i.nodeCircleMenuButton.radius / 2 + '" y2="-6" stroke-width="2" stroke="' + i.nodeCircleMenuButton.stroke + '"></line><line x1="-' + i.nodeCircleMenuButton.radius / 2 + '" y1="0" x2="' + i.nodeCircleMenuButton.radius / 2 + '" y2="0" stroke-width="2" stroke="' + i.nodeCircleMenuButton.stroke + '"></line><line x1="-' + i.nodeCircleMenuButton.radius / 2 + '" y1="6" x2="' + i.nodeCircleMenuButton.radius / 2 + '" y2="6" stroke-width="2" stroke="' + i.nodeCircleMenuButton.stroke + '"></line></g>'),
        n
    },
    expandCollapseBtn: function(t, e, r, i, a) {
        ...
        if (i !== OrgChart.action.exporting && !e.isSplit) {
            ...
            if (e.childrenIds.length > 0) {
                if (e.hasPartners) {
                    for (var c = !1, d = 0; d < e.children.length; d++)
                        e.children[d].parentPartner || e.children[d].isPartner || (c = !0);
                    if (!c)
                        return ""
                }
                ...
                if (l -= h.expandCollapseSize / 2,
                s -= h.expandCollapseSize / 2,
                t.getCollapsedIds(e).length ? (n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", l).replace("{y}", s),
                n += h.plus,
                n += OrgChart.grCloseTag) : (n += OrgChart.expcollOpenTag.replace("{id}", e.id).replace("{x}", l).replace("{y}", s),
                n += h.minus,
            ...
            t._nodeHasHiddenParent(e) && (n += OrgChart.upOpenTag.replace("{id}", e.id).replace("{x}", e.x).replace("{y}", e.y),
            n += h.up,
            n += OrgChart.grCloseTag)
        }
        var p = {
        ...
        return OrgChart.events.publish("renderbuttons", [t, p]),
        p.html
    },
    link: function(t, e, r, i, a, n) {
        ...
        if (t.hasPartners) {
            ...
            for (var u = 0; u < t.children.length; u++) {
                (m = t.children[u]).parentPartner ? (f.ppnodes[m.id] = m.parentPartner,
                f.ids.push(m.id),
                1 == m.parentPartner.isPartner ? (-1 == f.rightIds.indexOf(m.parentPartner.id) && f.rightIds.push(m.parentPartner.id),
                f.indexes[m.id] = f.rightIds.indexOf(m.parentPartner.id),
                f.firstRight || (f.firstRight = m)) : 2 == m.parentPartner.isPartner && (-1 == f.leftIds.indexOf(m.parentPartner.id) && f.leftIds.push(m.parentPartner.id),
                f.indexes[m.id] = f.leftIds.indexOf(m.parentPartner.id),
                f.lastLeft = m)) : m.isPartner || (f.lastLeft = m,
                f.firstRight || (f.firstRight = m))
            }
            f.maxSidePartnersWithChildren = Math.max(f.leftIds.length, f.rightIds.length),
            d = 0 == f.maxSidePartnersWithChildren ? e.config.minPartnerSeparation / 2 : e.config.minPartnerSeparation / 2 + f.partnerChildrenSplitSeparation * f.maxSidePartnersWithChildren + f.partnerChildrenSplitSeparation / 2
        }
        for (u = 0; u < t.children.length; u++) {
            var m = t.children[u]
              , C = i[g][m.sl]
              , b = {
                xa: 0,
            ...
            if (f && -1 != f.ids.indexOf(m.id))
                switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    b = OrgChart.ui._linkPpTop(f, t, m, C, p, s);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    b = OrgChart.ui._linkPpBottom(f, t, m, C, p, s);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    b = OrgChart.ui._linkPpRight(f, t, m, C, p, s);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    b = OrgChart.ui._linkPpLeft(f, t, m, C, p, s)
                }
            else if ((m.isAssistant || 2 == m.layout) && m.rightNeighbor && m.rightNeighbor.isSplit)
                switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                case OrgChart.orientation.bottom:
            ...
            else if ((m.isAssistant || 2 == m.layout) && m.leftNeighbor && m.leftNeighbor.isSplit)
                switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                case OrgChart.orientation.bottom:
                ...
                case OrgChart.orientation.top_left:
                    if (1 == m.isPartner)
                        b = OrgChart.ui._linkLeftToRight(t, m, s, d);
                    else if (2 == m.isPartner)
                        b = OrgChart.ui._linkRightToLeft(t, m, s, d);
                    else {
                ...
                case OrgChart.orientation.right_top:
                    if (1 == m.isPartner)
                        b = OrgChart.ui._linkTopToBottom(t, m, s, d);
                    else if (2 == m.isPartner)
                        b = OrgChart.ui._linkBottomToTop(t, m, s, d);
                    else {
            ...
            if (-1 != O.indexOf("{rounded}"))
                if (b.xa == b.xb && b.xa == b.xc && b.xa == b.xd || b.ya == b.yb && b.ya == b.yc && b.ya == b.yd)
                    O = O.replace("{rounded}", "M" + b.xa + "," + b.ya + " L" + b.xd + "," + b.yd);
                else {
            ...
            OrgChart.events.publish("render-link", [e, _]),
            h.push(_.html);
            var w = "";
            for (var k in e.config.linkBinding) {
                ...
                if (I) {
                    ...
                    _.element = s[k],
                    _.name = S,
                    !1 !== OrgChart.events.publish("label", [e, _]) && (OrgChart.isNEU(_.value) || OrgChart.isNEU(_.element) || (w += _.element.replace("{val}", _.value)))
                }
            }
            "" != w && (w = OrgChart.linkFieldsOpenTag.replace("{x}", b.x).replace("{y}", b.y).replace("{rotate}", 0) + w + OrgChart.grCloseTag,
            h.push(w)),
            h.push(OrgChart.grCloseTag)
        }
        return h.join("")
    },
    ...
    _roundedEdge: function(t, e, r, i, a, n) {
        ...
        Math.abs(e - n) < o && (o = 0);
        var l, s, h, c = 0;
        return t == r && t == a || e == i && e == n ? (l = h = r,
        s = c = i) : (t != a && r == a && (l = h = r,
        s = i,
        e < n ? c = i + o : e > n && (c = i - o)),
        t < a && r == a ? r -= o : t > a && r == a && (r += o),
        e != n && i == n && (l = r,
        s = c = i,
        t < a ? h = r + o : t > a && (h = r - o)),
        e < n && i == n ? i -= o : e > n && i == n && (i += o)),
        {
            x1: t,
            y1: e,
            x2: r,
    ...
    _linkTopToBottom: function(t, e, r, i, a) {
        var n, o, l, s, h, c = 0;
        return n = t.x + t.w / 2 + r.linkAdjuster.toX,
    ...
    _linkRightToLeft: function(t, e, r, i, a) {
        var n, o, l, s, h, c, d = 0;
        return n = t.x + r.linkAdjuster.toX,
        o = t.y + t.h / 2 + r.linkAdjuster.toY,
        h = e.x + e.w + r.linkAdjuster.fromX,
        c = s = e.y + e.h / 2 + r.linkAdjuster.fromY,
        l = o,
        90,
        {
            xa: n,
    ...
    _linkLeftToRight: function(t, e, r, i, a) {
        var n, o, l, s, h, c, d = 0;
        return n = t.x + t.w + r.linkAdjuster.toX,
        o = t.y + t.h / 2 + r.linkAdjuster.toY,
    ...
    _linkPpTop: function(t, e, r, i, a, n) {
        var o = t.ppnodes[r.id]
          ...
          , c = OrgChart.ui.__linkPpBottomTop(t, e, r, s, h, o)
          , d = c.x;
        return s = c.mid,
        OrgChart.ui._linkTopToBottom({
            x: d,
            y: l,
            w: 0,
            h: 0
    ...
    _linkPpLeft: function(t, e, r, i, a, n) {
        var o = t.ppnodes[r.id]
          ...
          , h = o.x + o.w / 2
          , c = OrgChart.ui.__linkPpLeftRight(t, e, r, l, s, o)
          , d = c.y;
        return l = c.mid,
    ...
    __linkPpBottomTop: function(t, e, r, i, a, n) {
        var o = 0;
        return 1 == n.isPartner ? (o = n.x - e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - (t.rightIds.length - 1) * t.partnerChildrenSplitSeparation / 2,
        t.lastLeft && o < t.lastLeft.x + t.lastLeft.w / 2 ? o < r.x + r.w / 2 ? i -= (t.indexes[r.id] + 1) * a : i -= (t.rightIds.length - t.indexes[r.id]) * a : o < r.x + r.w / 2 ? i += (t.rightIds.length - t.indexes[r.id]) * a : i += (t.indexes[r.id] + 1) * a) : 2 == n.isPartner && (o = n.x + n.w + e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - (t.leftIds.length - 1) * t.partnerChildrenSplitSeparation / 2,
        t.firstRight && o > t.firstRight.x + t.firstRight.w / 2 ? o < r.x + r.w / 2 ? i -= (t.indexes[r.id] + 1) * a : i -= (t.leftIds.length - t.indexes[r.id]) * a : o < r.x + r.w / 2 ? i += (t.leftIds.length - t.indexes[r.id]) * a : i += (t.indexes[r.id] + 1) * a),
        {
            x: o,
            mid: i
        }
    ...
    __linkPpLeftRight: function(t, e, r, i, a, n) {
        var o = 0;
        return 1 == n.isPartner ? (o = n.y - e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - (t.rightIds.length - 1) * t.partnerChildrenSplitSeparation / 2,
        t.lastLeft && o < t.lastLeft.y + t.lastLeft.h / 2 ? o < r.y + r.h / 2 ? i -= (t.indexes[r.id] + 1) * a : i -= (t.rightIds.length - t.indexes[r.id]) * a : o < r.y + r.h / 2 ? i += (t.rightIds.length - t.indexes[r.id]) * a : i += (t.indexes[r.id] + 1) * a) : 2 == n.isPartner && (o = n.y + n.h + e.partnerSeparation / 2 + t.indexes[r.id] * t.partnerChildrenSplitSeparation - (t.leftIds.length - 1) * t.partnerChildrenSplitSeparation / 2,
        t.firstRight && o > t.firstRight.y + t.firstRight.h / 2 ? o < r.y + r.h / 2 ? i -= (t.indexes[r.id] + 1) * a : i -= (t.leftIds.length - t.indexes[r.id]) * a : o < r.y + r.h / 2 ? i += (t.leftIds.length - t.indexes[r.id]) * a : i += (t.indexes[r.id] + 1) * a),
        {
            y: o,
            mid: i
        }
...
OrgChart._validateConfig = function(t) {
    return !!t || (console.error("config is not defined"),
    !1)
}
,
...
OrgChart._getTransform = function(t) {
    ...
    return e = e.replace("matrix", "").replace("(", "").replace(")", ""),
...
OrgChart.mergeDeep = function(t, e) {
    if (OrgChart.isObject(t) && OrgChart.isObject(e))
        for (var r in e)
            OrgChart.isObject(e[r]) ? (t[r] || Object.assign(t, {
                [r]: {}
            }),
...
OrgChart._fieldIsImg = function(t, e) {
    if (t.nodeBinding)
        for (var r in t.nodeBinding)
            if (t.nodeBinding[r] == e)
                return OrgChart._lblIsImg(t, r);
    return !1
}
,
...
OrgChart.htmlRipple = function(t) {
    ...
    t.addEventListener("mousedown", (function(e) {
        ...
        n = "top:" + (e.pageY - r.top - a / 2) + "px; left: " + o + "px; height: " + a + "px; width: " + a + "px;",
...
OrgChart._moveToBoundaryArea = function(t, e, r, i) {
    ...
    e[0] !== a[0] || e[1] !== a[1] ? OrgChart.anim(t, {
        viewBox: e
    }, {
        viewBox: a
...
OrgChart._getTopLeft = function(t) {
    ...
    return OrgChart._getOffset(t, e),
    e
}
,
...
OrgChart._menuPosition = function(t, e, r) {
    var i = t.getBoundingClientRect()
      ...
      , o = i.left - a.left
      , l = i.top - a.top;
    return i.top + n.height > a.top + a.height && (l -= n.height),
...
OrgChart._getTestDiv = function() {
    ...
    return t || ((t = document.createElement("div")).id = "orgchart_js_test_div",
...
OrgChart.wrapText = function(t, e) {
    ...
    if (-1 == r.indexOf("<text"))
        return t;
    if (-1 == r.indexOf(OrgChart.attr.width))
        return t;
    if (-1 != r.indexOf("foreignobject"))
        return t;
    if (-1 == e.indexOf(OrgChart.attr.width))
        return t;
    if (OrgChart._isHTML(t))
        return t;
    var i = OrgChart._getTestDiv();
    e = e.replaceAll("{cw}", 0),
    i.innerHTML = "<svg>" + e + "</svg>";
    var a, n, o = (new DOMParser).parseFromString(e, "text/xml").getElementsByTagName("text")[0], l = parseFloat(o.getAttribute("x")), s = parseFloat(o.getAttribute("y")), h = o.getAttribute("text-anchor"), c = o.getAttribute(OrgChart.attr.width), d = o.getAttribute(OrgChart.attr.text_overflow), g = "http://www.w3.org/2000/svg", p = i.getElementsByTagName("svg")[0].getElementsByTagName("text")[0];
    d || (d = "ellipsis");
    var f = d.split("-");
    if (f.length > 1 && (a = parseInt(d.split("-")[1]),
    ...
    "ellipsis" == d) {
        ...
        p.textContent = t;
        for (var u = p.getComputedTextLength(), m = 2; u > c; )
    ...
    if (-1 != d.indexOf("multiline")) {
        var C = t.split(" ")
          , b = p.getBBox().height;
        p.textContent = "";
        var O = document.createElementNS(g, "tspan")
          , v = document.createTextNode(C[0]);
        O.setAttributeNS(null, "x", l),
        O.setAttributeNS(null, "y", s),
        O.setAttributeNS(null, "text-anchor", h),
        O.appendChild(v),
        p.appendChild(O);
        m = 1;
        for (var x = 1, y = 1; y < C.length; y++) {
            var _ = O.firstChild.data.length;
            if (O.firstChild.data += " " + C[y],
            O.getComputedTextLength() > c) {
                if (O.firstChild.data = O.firstChild.data.slice(0, _),
                x++,
                a && x > a) {
                ...
                (O = document.createElementNS(g, "tspan")).setAttributeNS(null, "x", l),
                O.setAttributeNS(null, "y", s + b * m),
                O.setAttributeNS(null, "text-anchor", h),
                v = document.createTextNode(C[y]),
                O.appendChild(v),
                p.appendChild(O),
                m++
            }
        ...
        if (null != p.innerHTML)
            ...
            var S = "";
            for (y = p.childNodes.length - 1; y >= 0; y--)
                S = XMLSerializer().serializeToString(p.childNodes[y]) + S,
                p.removeChild(p.childNodes[y]);
            k = S
        }
        return k
    }
...
OrgChart._getPosition = function(t, e, r, i) {
    ...
    t && 3 == t.length) {
        ...
        -1 != n && null != t[1][n].transform && (null == r && (a.x = t[1][n].transform[4]),
...
OrgChart.setNodeSize = function(t) {
    ...
    t.w = e && e.size ? e.size[0] : 0,
    t.h = e && e.size ? e.size[1] : 0
}
,
    ...
    for (var o = 0; o < n; o++)
        !function() {
            ...
            OrgChart._getDataUri(e.getAttribute(r), (function(a) {
                a.success && e.setAttribute(r, a.result),
                t == n - 1 && i()
            }
            ))
        }()
...
OrgChart._json2xml = function(t) {
    ...
    '<?xml version="1.0" encoding="utf-8" ?>' + (new XMLSerializer).serializeToString(e.documentElement)
}
,
...
OrgChart._json2csv = function(t) {
    for (var e = [], r = function(t) {
        ...
        for (var n in t[a])
            OrgChart._arrayContains(e, n) || (e.push(n),
            i += n + ",");
...
OrgChart.copy = function(t) {
    if (null === t || "object" != typeof t || "isActiveClone"in t)
        return t;
    if (t instanceof Date)
        ...
        e = t.constructor();
    for (var r in t)
        Object.prototype.hasOwnProperty.call(t, r) && (t.isActiveClone = null,
...
OrgChart.collapsedChildrenCount = function(t, e, r) {
    ...
    for (var i = 0; i < e.childrenIds.length; i++) {
        var a = t.nodes[e.childrenIds[i]];
        a && (!0 === a.collapsed && r++,
        OrgChart.collapsedChildrenCount(t, a, r))
    }
    return r
}
,
...
OrgChart.getStParentNodes = function(t, e) {
    for (e || (e = []); t.parent; )
        t = t.parent;
    return t.stParent && (e.push(t.stParent),
    OrgChart.getStParentNodes(t.stParent, e)),
    e
}
,
...
OrgChart._getViewBox = function(t) {
    var e = null;
    return t ? (e = (e = "[" + (e = t.getAttribute("viewBox")) + "]").replace(/\ /g, ","),
    e = JSON.parse(e)) : null
}
,
    ...
    if ((this.config.mouseScrool == OrgChart.action.xScroll || this.config.mouseScrool == OrgChart.action.scroll) && this.bar) {
        ...
        !function(t, r, i) {
            ...
            function n() {
                ...
                Math.ceil(e.bar.scrollLeft) == Math.ceil(e.pos) ? a = !1 : (e.bar.scrollLeft += t,
                o(n))
            }
            t.addEventListener("wheel", (function(t) {
                var i = 0;
                if (e.config.mouseScrool == OrgChart.action.xScroll)
                    (i = t.deltaX || t.wheelDeltaX) || (i = t.deltaY || t.wheelDeltaY);
                else if (e.config.mouseScrool == OrgChart.action.scroll && !(i = t.shiftKey ? t.deltaY || t.wheelDeltaY : t.deltaX || t.wheelDeltaX))
                    return;
                i = -i,
    ...
    if (this.config.mouseScrool == OrgChart.action.yScroll || this.config.mouseScrool == OrgChart.action.scroll) {
        ...
        !function(t, r, i) {
            ...
            function n() {
                ...
                Math.ceil(e.bar.scrollTop) == Math.ceil(e.pos) ? a = !1 : (e.bar.scrollTop += t,
                o(n))
            }
            t.addEventListener("wheel", (function(t) {
                var i = 0;
                if (e.config.mouseScrool == OrgChart.action.yScroll)
                    (i = t.deltaY || t.wheelDeltaY) || (i = t.deltaX || t.wheelDeltaX);
                else if (e.config.mouseScrool == OrgChart.action.scroll && !(i = t.shiftKey ? t.deltaX || t.wheelDeltaX : t.deltaY || t.wheelDeltaY))
                    return;
                i = -i,
                i = Math.max(-1, Math.min(1, i)),
                e.pos += -i * r;
...
OrgChart.prototype.zoom = function(t, e, r, i) {
    var a = this.getViewBox().slice(0)
      ...
      , o = a[2]
      , l = a[3];
    !0 === t ? (a[2] = a[2] / OrgChart.SCALE_FACTOR,
    a[3] = a[3] / OrgChart.SCALE_FACTOR) : !1 === t ? (a[2] = a[2] * OrgChart.SCALE_FACTOR,
    a[3] = a[3] * OrgChart.SCALE_FACTOR) : (a[2] = a[2] / t,
    a[3] = a[3] / t),
    e || (e = [50, 50]),
    ...
    if (a[2] = this.width() / s,
    a[3] = this.height() / s,
    !0 === t && s < this.config.scaleMax || !1 === t && s > this.config.scaleMin || 0 != t && 1 != t && s < this.config.scaleMax && s > this.config.scaleMin) {
        this._hideBeforeAnimation();
        var h = this;
        r ? (clearTimeout(h._timeout),
        OrgChart.anim(this.getSvg(), {
...
OrgChart.loading.show = function(t) {
    var e = document.createElement("div");
    e.id = "boc-loading",
    e.innerHTML = '<style>@-webkit-keyframes dot-keyframes {0% { opacity: .4; -webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}@keyframes dot-keyframes {0% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}50% {opacity: 1;-webkit-transform: scale(1.2, 1.2);transform: scale(1.2, 1.2);}100% {opacity: .4;-webkit-transform: scale(1, 1);transform: scale(1, 1);}}.boc-loading-dots div {margin: 10px;}      .boc-dot-1 {background-color: #039BE5;}.boc-dot-2 {background-color: #F57C00;}.boc-dot-3 {background-color: #FFCA28;}      .boc-loading-dots {text-align: center;width: 100%; position: absolute; top: 0;}.boc-loading-dots--dot {-webkit-animation: dot-keyframes 1.5s infinite ease-in-out;animation: dot-keyframes 1.5s infinite ease-in-out;        border-radius: 10px;display: inline-block;height: 10px;width: 10px;}.boc-loading-dots--dot:nth-child(2) {-webkit-animation-delay: .5s;animation-delay: .5s;}.boc-loading-dots--dot:nth-child(3) {-webkit-animation-delay: 1s;animation-delay: 1s;}</style><div class="boc-loading-dots"><div class="boc-loading-dots--dot boc-dot-1"></div><div class="boc-loading-dots--dot boc-dot-2"></div><div class="boc-loading-dots--dot boc-dot-3"></div></div>',
...
OrgChart.pdfPrevUI.show = function(t, e) {
    ...
    i.innerHTML = '<div id="boc-ppdf-content" style="width: 100%;margin-top:10px;margin-bottom:10px;opacity:0;"></div>';
    var a, n, o, l = t.element.querySelector("#boc-ppdf-size"), s = t.element.querySelector("#boc-ppdf-layout"), h = t.element.querySelector("#boc-ppdf-scale"), c = t.element.querySelector("#boc-ppdf-margin"), d = t.element.querySelector("#boc-ppdf-header"), g = t.element.querySelector("#boc-ppdf-footer");
    l.value = e.format,
    s.value = e.landscape,
    h.value = e.scale,
    c.value = e.margin,
    d.value = e.header,
    g.value = e.footer,
    OrgChart.anim(t.element.querySelector("#boc-ppdf-btns"), {
        margin: [0, 0, 0, -250]
    }, {
        margin: [0, 0, 0, 0]
    }, 300, OrgChart.anim.outSin, (function() {
    ...
    l.addEventListener("change", (function() {
        OrgChart.anim(t.element.querySelector("#boc-ppdf-content"), {
            opacity: 1
        }, {
            opacity: 0
...
OrgChart.pdfPrevUI._showHide = function(t, e, r) {
    "A4" == t.value || "A3" == t.value || "A2" == t.value || "A1" == t.value || "Letter" == t.value || "Legal" == t.value ? (e.parentNode.style.display = "block",
    r.parentNode.style.display = "block") : (e.parentNode.style.display = "none",
...
OrgChart.pdfPrevUI._handler = function(t, e, r) {
    ...
    OrgChart._browser().msie && (l.innerHTML = (new XMLSerializer).serializeToString(r));
    for (var s = l.querySelector("svg"), h = t.element.querySelector("#boc-ppdf-content"), c = 0; c < a.length; c++) {
        ...
        g.open(),
        d.style.width = a[c].size.w + "px",
        d.style.height = a[c].size.h + "px",
        d.style.margin = "10 auto",
        a[c].backgroundColor && (d.style.backgroundColor = a[c].backgroundColor);
        var p = i.header;
        a[c].header && (p = a[c].header),
        p && (p = p.replace("{current-page}", c + 1).replace("{total-pages}", a.length));
        var f = i.footer;
        a[c].footer && (f = a[c].footer),
        f && (f = f.replace("{current-page}", c + 1).replace("{total-pages}", a.length)),
        a[c].html ? g.write(OrgChart._exportHtml(a[c].html, e.styles, i, a[c].innerSize.w, a[c].innerSize.h, p, f, t.config.mode)) : (s.setAttribute("viewBox", a[c].vb),
        g.write(OrgChart._exportHtml(l.innerHTML, e.styles, i, a[c].innerSize.w, a[c].innerSize.h, p, f, t.config.mode)));
        var u = g.getElementById("boc-header")
...
OrgChart._exportHtml = function(t, e, r, i, a, n, o, l) {
    for (var s = "", h = 0; h < r.margin.length; h++)
        s += r.margin[h] + "px ";
    var c = '<!DOCTYPE html><html style="margin:0;padding:0;"><head></head>' + e + '<body class="' + l + '" style="margin:0; padding:0;"><div style="margin: ' + s + ";overflow:hidden;width:" + i + "px;height:" + a + 'px">';
    return n && (c += '<div id="boc-header" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;top:0;">' + n + "</div>"),
    c += t,
    o && (c += '<div id="boc-footer" style="width:' + i + "px;color:#757575;position:absolute;left:" + r.margin[3] + 'px;bottom:0;">' + o + "</div>"),
    c += "</div>",
    c += "</body></html>"
}
,
...
OrgChart.prototype._clink = function(t, e) {
    for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (c && -1 != e.res.visibleNodeIds.indexOf(c.id) && (d && -1 != e.res.visibleNodeIds.indexOf(d.id))) {
            ...
            l += ("<g " + OrgChart.attr.c_link_from + '="{from}" ' + OrgChart.attr.c_link_to + '="{to}">').replace("{from}", c.id).replace("{to}", d.id) + k.link.replaceAll("{d}", I) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + I + '" />',
...
OrgChart.prototype._slinks = function(t, e) {
    ...
    function n(e, n, o) {
        ...
        var p = OrgChart.t(e.templateName, e.min, i)
          , f = g.levelSeparation;
        (e.parent && e.parent.layout == OrgChart.mixed || e.parent && e.parent.layout == OrgChart.tree) && (f = g.mixedHierarchyNodesSeparation);
        var u = {
        ...
        if (e.level == n.level)
            ...
            case OrgChart.orientation.left_top:
                u.p = e.x,
                u.q = e.y + e.h / 2 + p.expandCollapseSize,
                u.r = a.minX - f,
                u.s = e.y + e.h / 2 + p.expandCollapseSize,
                s.push([u.p, u.q]),
                s.push([e.x - f / 3, u.q]),
                p = OrgChart.t(h.templateName, h.min, i),
            ...
            for (var m = e; null == h; ) {
                var C = !1
                  ...
                  , O = b.leftNeighbor
                  , v = b.rightNeighbor;
                if (b.id == n.id ? h = b : OrgChart._intersects(b, u, t.config) && (u = OrgChart._addPoint(b, s, t.config, u, c),
                C = !0),
                b.id != n.id) {
                    for (; O; ) {
                        if (O.id == n.id) {
                        ...
                        OrgChart._intersects(O, u, t.config) && (u = OrgChart._addPoint(O, s, t.config, u, c),
                        C = !0),
                        O = O.leftNeighbor
                    }
                    for (; v; ) {
                        ...
                        OrgChart._intersects(v, u, t.config) && (u = OrgChart._addPoint(v, s, t.config, u, c),
                        C = !0),
                        v = v.rightNeighbor
                    }
                }
                if (!C) {
                    var x = s[s.length - 1][0]
                      , y = 0;
                    if (b.parent)
                        switch (f = g.levelSeparation,
                        b.parent.layout != OrgChart.mixed && b.parent.layout != OrgChart.tree || (f = g.mixedHierarchyNodesSeparation),
                        g.orientation) {
                        case OrgChart.orientation.top:
                        case OrgChart.orientation.top_left:
                            y = b.parent.y + b.parent.h + f * (2 / 3);
                            break;
                        case OrgChart.orientation.bottom:
                        case OrgChart.orientation.bottom_left:
                            y = b.parent.y - f * (2 / 3);
            ...
            switch (p = OrgChart.t(h.templateName, h.min, i),
        ...
        var N = s.join(" ");
        if (l.label) {
            var L = p.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", l.label)
              , M = OrgChart._getLabelSize(L)
              , E = -M.height / 2;
            switch (g.orientation) {
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
        ...
        r += ("<g " + OrgChart.attr.s_link_from + '="{from}" ' + OrgChart.attr.s_link_to + '="{to}">').replace("{from}", e.id).replace("{to}", n.id) + p.link.replaceAll("{d}", N) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + N + '" />',
...
OrgChart.events.on("redraw", (function(t, e) {
    if (t.config.miniMap) {
        ...
        i.translate(-t.response.boundary.minX * o + l, -t.response.boundary.minY * o + s),
        i.scale(o, o);
        var h = 0
          , c = [];
        !function t(e, r) {
            if (Array.isArray(r))
                ...
                i.fillStyle = OrgChart.miniMap.colors[3],
                i.beginPath(),
                i.lineWidth = "0.5",
                i.fillRect(r.x, r.y, r.w, r.h),
                i.strokeRect(r.x, r.y, r.w, r.h);
                for (a = 0; a < r.stChildrenIds.length; a++)
                    h++,
                    c.includes(r.id) || (1 == h ? i.fillStyle = OrgChart.miniMap.colors[0] : 2 == h ? i.fillStyle = OrgChart.miniMap.colors[1] : 3 == h && (i.fillStyle = OrgChart.miniMap.colors[2]),
                    i.beginPath(),
                    i.fillRect(r.x, r.y, r.w, r.h),
                    i.strokeRect(r.x, r.y, r.w, r.h),
                    c.push(r.id)),
                    t(e, e.getNode(r.stChildrenIds[a])),
                    h--;
                for (a = 0; a < r.childrenIds.length; a++)
                    t(e, e.getNode(r.childrenIds[a]))
            }
        }(t, t.roots);
        var d = t.getViewBox()[0]
          , g = t.getViewBox()[1]
          , p = t.getViewBox()[2]
          , f = t.getViewBox()[3];
        i.lineWidth = .5 / o,
        i.strokeStyle = "#f57c00",
        i.strokeRect(d, g, p, f),
        i.globalAlpha = .4,
...
OrgChart.miniMap = {},
OrgChart.miniMap._getCanvas = function(t) {
    if (!(e = t.element.querySelector("[" + OrgChart.attr.id + '="mini-map"]'))) {
        var e;
        (e = document.createElement("canvas")).width = 250,
        e.height = 140,
        e.setAttribute(OrgChart.attr.id, "mini-map"),
        e.style.display = "inline-block",
        e.style.backgroundColor = OrgChart.miniMap.backgroundColor;
        var r = document.createElement("div");
        r.classList.add("mini-map"),
        r.style.position = "absolute",
        r.style.bottom = "10px",
        r.style.left = "10px",
        r.style.border = "1px solid #aeaeae",
        r.style.padding = "5px",
        r.style.margin = t.config.padding + "px",
        r.style.backgroundColor = OrgChart.miniMap.backgroundColor,
        r.appendChild(e),
        t.element.appendChild(r)
    }
    return e
...
OrgChart._search = {},
OrgChart._search.search = function(t, e, r, i, a, n) {
    var o = []
    ...
    for (var s = {}, h = 0; h < t.length; h++)
        for (var c = t[h], d = 0; d < r.length; d++) {
            var g = r[d];
...
OrgChart._search.addNodeToResult = function(t, e, r, i, a, n) {
    var o = {};
    o.id = r.id,
    OrgChart.isNEU(r[n]) || (o[n] = r[n]);
    for (var l = 0; l < e.length; l++) {
        var s = e[l];
        OrgChart.isNEU(r[s]) || OrgChart.isNEU(o[s]) && (o[s] = r[s])
    }
    null != i && (OrgChart.isNEU(o.__score) && (o.__score = i.__score),
...
OrgChart._search.searchAndComputeScore = function(t, e, r, i) {
    ...
    for (c = n.length - 1; c >= 0; c--)
        u = (u = u.insert(n[c].start + n[c].length, "</mark>")).insert(n[c].start, "<mark>");
    return {
        __searchMarks: u,
        __score: f
    }
    ...
    if (t.config.state) {
        ...
        !function t(e) {
            if (Array.isArray(e))
                ...
                ("string" != typeof e.id || "string" == typeof e.id && -1 == e.id.indexOf("split") && -1 == e.id.indexOf("mirror")) && (r.push(e.id),
                1 == e.min && i.push(e.id));
        ...
        OrgChart.state._put(t.width(), t.height(), t.response.viewBox, r, i, t.response.adjustify, t.config.state)
    }
}
)),
OrgChart.state = {},
...
OrgChart.state._put = function(t, e, r, i, a, n, o) {
    if (o) {
        ...
        if (o.writeToUrlParams) {
            ...
            h.has(l.paramScale) ? h.set(l.paramScale, s.scale) : h.append(l.paramScale, s.scale),
            h.has(l.paramX) ? h.set(l.paramX, s.x) : h.append(l.paramX, s.x),
            h.has(l.paramY) ? h.set(l.paramY, s.y) : h.append(l.paramY, s.y),
            h.has(l.paramExp) ? h.set(l.paramExp, s.exp.join("*")) : h.append(l.paramExp, s.exp.join("*")),
            h.has(l.paramMin) ? h.set(l.paramMin, s.min.join("*")) : h.append(l.paramMin, s.min.join("*")),
            h.has(l.paramAdjustify) ? h.set(l.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y) : h.append(l.paramAdjustify, s.adjustify.x + "*" + s.adjustify.y),
            window.history.replaceState(null, null, "?" + h)
        }
        o.writeToIndexedDB && (s.id = o.name,
        OrgChart.idb.put(s, (function(t) {
    ...
    if (t) {
        ...
        if (t.readFromLocalStorage) {
            ...
            if (null != (o = OrgChart.localStorage.getItem(t.name)))
                ...
                o.vb = d,
                void i(o);
            if (!t.readFromIndexedDB)
                return void i(null)
        }
        t.readFromIndexedDB && OrgChart.idb.read(t.name, (function(a, n) {
            if (0 == a)
                console.error("Cannot read from - " + t.name),
                i(null);
            else if (null == a)
                i(null);
            else {
...
OrgChart.prototype.magnify = function(t, e, r, i, a) {
    ...
    if (n || o) {
        ...
        if (l && (null != l.timer && clearInterval(l.timer),
        null != l.timerBack && clearInterval(l.timerBack),
        o.setAttribute("transform", "matrix(" + l.transformStart.toString() + ")"),
        OrgChart._magnify[t]),
        r)
            o = o.cloneNode(!0),
            this.getSvg().appendChild(o);
...
OrgChart.prototype.magnifyBack = function(t, e, r) {
    ...
    if (i) {
        ...
        i.timerBack = OrgChart.anim(i.nodeElement, {
            ...
            OrgChart._magnify[e] && OrgChart._magnify[e].front && (t[0].parentNode.removeChild(t[0]),
            OrgChart._magnify[e] = null),
            r && r(t[0])
        }
        ))
    }
...
OrgChart.events.on("init", (function(t, e) {
    t.config.enableKeyNavigation && (t._addEvent(window, "keydown", t._windowKeyDownHandler),
            ...
            if ("KeyF" == e.code)
                ...
                if (s = this.getNode(a.pid)) {
                    ...
                    if (++o < s.childrenIds.length) {
                        ...
                        this._keyNavigationActiveNodeId = l,
                        this.center(l)
                    }
                }
                ...
                a.childrenIds.length && (this._keyNavigationActiveNodeId = a.childrenIds[0],
...
OrgChart.events.on("click", (function(t, e) {
    t.config && t.config.enableKeyNavigation && (t._keyNavigationActiveNodeId = e.node.id,
    t.center(e.node.id))
}
)),
OrgChart._keyNavigation = function(t) {
    ...
    if (!OrgChart.isNEU(t._keyNavigationActiveNodeId) && ((r = t.getNodeElement(t._keyNavigationActiveNodeId)) && r.children.length)) {
        ...
        if (OrgChart.events.publish("screen-reader-text", [t, n]),
...
OrgChart.elements.select = function(t, e, r, i) {
    if (i)
        return OrgChart.elements.textbox(t, e, r, i);
    var a = OrgChart.elements._vidrf(t, e, i);
...
OrgChart.elements._vidrf = function(t, e, r) {
    var i = {};
    if (e.binding || (e.binding = ""),
    e.label || (e.label = ""),
    "select" != e.type || Array.isArray(e.options) ? i.options = e.options : i.options = [],
...
OrgChart.elements.generateId = function() {
    for (; ; ) {
        ...
        if (!OrgChart.elements.ids.has(t))
            return OrgChart.elements.ids.push(t),
            t
    }
}
,
...
OrgChart.input.initWithTimeout = function() {
    OrgChart.input._timeout && (clearTimeout(OrgChart.input._timeout),
    OrgChart.input._timeout = null),
...
OrgChart.input.init = function(t) {
    ...
    for (var r = 0; r < e.length; r++) {
        ...
        n && (a.value || "select-one" == a.type && a.selectedOptions && a.selectedOptions.length && "" == a.selectedOptions[0].value && a.selectedOptions[0].innerHTML) && n.classList.add("hasval"),
        "checkbox" != a.type.toLowerCase() && a.addEventListener("focus", (function() {
        ...
        "checkbox" != a.type.toLowerCase() && a.addEventListener("blur", (function() {
            ...
            this.value || "date" == this.type ? t.classList.add("hasval") : t.classList.remove("hasval")
        }
        ))
    }
}
...
OrgChart.input.validate = function(t) {
    ...
    if (e.classList.remove("boc-validation-error"),
    r) {
    ...
    return a && "" == e.value ? (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + a + "</span>",
    e.classList.add("boc-validation-error"),
    !1) : n && !OrgChart.input.validatePassword(e.value) ? (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + n + "</span>",
    e.classList.add("boc-validation-error"),
    !1) : o && !OrgChart.input.isValidEmail(e.value) ? (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + o + "</span>",
    e.classList.add("boc-validation-error"),
    !1) : !(l && !OrgChart.input.isValidEmails(e.value)) || (r.innerHTML += '<span class="boc-validation-error-message">&nbsp;' + l + "</span>",
    e.classList.add("boc-validation-error"),
    !1)
}
,
...
OrgChart.input.isValidEmails = function(t) {
    if (t)
        for (var e = t.split(","), r = 0; r < e.length; r++) {
            var i = e[r].trim();
            if (!OrgChart.input.isValidEmail(i))
                return !1
        }
    return !0
}
...
void 0 === OrgChart && (OrgChart = {}),
OrgChart.local = {},
OrgChart.local._setPositions = function(t, e, r) {
    for (var i = {}, a = 0; a < t.length; a++) {
        if ((s = t[a]).stContainerNodes)
            for (var n = s.stContainerNodes.length - 1; n >= 0; n--) {
                var o = s.stContainerNodes[n]
                  , l = OrgChart.local._walk(o.stChildren, e);
    ...
    OrgChart.local._walk(t, e);
    for (a = 0; a < t.length; a++) {
        var s;
        if ((s = t[a]).stContainerNodes)
            for (n = 0; n < s.stContainerNodes.length; n++)
                for (var h = (o = s.stContainerNodes[n]).x, c = o.y, d = 0; d < o.stChildren.length; d++) {
                    var g = o.stChildren[d];
                    OrgChart.local._lastWalk(g, h, c, i[o.id], o.padding)
                }
    }
    r()
}
,
OrgChart.local._walk = function(t, e) {
    for (var r = {
        minX: null,
        minY: null,
        maxX: null,
        maxY: null
    }, i = [], a = [], n = [], o = 0; o < t.length; o++) {
        var l = e[t[o].lcn ? t[o].lcn : "base"];
        0 == o - (s = parseInt(o / l.columns)) * l.columns && (n = []),
        OrgChart.local._firstWalk(t[o], 0, i, n, l)
    }
    for (o = 0; o < t.length; o++) {
        l = e[t[o].lcn ? t[o].lcn : "base"],
        s = parseInt(o / l.columns),
        l.columns;
        var s, h = 0;
        switch (s > 0 && (h = a[s - 1] + l.siblingSeparation),
        OrgChart.local._secondWalk(t[o], 0, 0, h, i, r, l),
        a[s] = r.maxY - r.minY,
        l.orientation) {
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
...
,
OrgChart.local._firstWalk = function(t, e, r, i, a) {
    if (!t.isPartner) {
        var n = null;
        if (t.x = 0,
        t.y = 0,
        ...
        t._modifier = 0,
        t.leftNeighbor = null,
        t.rightNeighbor = null,
        OrgChart.local._setLevelMaxNodeHeight(t, e, r, a),
        OrgChart.local._setNeighbors(t, e, i),
        OrgChart.local._hasChildren(t) && e != OrgChart.MAX_DEPTH) {
            for (var o = t.children.length, l = 0; l < o; l++)
                OrgChart.local._firstWalk(t.children[l], e + 1, r, i, a);
            var s = OrgChart.local._fChild(t)
              , h = t.children[t.children.length - 1]
              , c = s._prelim + (h._prelim - s._prelim) / 2 + OrgChart.local._leftMidPoint(h, a);
            if (s.isAssistant && h.isAssistant && (c = s._prelim + (h._prelim - s._prelim) / 2 + OrgChart.local._leftMidPoint(s, a)),
            c -= OrgChart.local._mid(t, a),
            null != (n = OrgChart.local._getLeftSibling(t))) {
                d = a.siblingSeparation;
                if (t.isAssistant && t.isSplit)
                    d = a.assistantSeparation;
                else if (2 == n.layout)
                    d = a.mixedHierarchyNodesSeparation;
                else if (n.parent && 4 == n.parent.hasPartners && a.orientation <= 3) {
                    g = OrgChart.local._size(n.parent, a),
                    p = OrgChart.local._rightMidPoint(n, a);
                    (d = n.parent.partnerSeparation + g / 2 - p) < a.siblingSeparation && (d = a.siblingSeparation)
                }
                t._prelim = n._prelim + OrgChart.local._nodeWithPartnersSize(n, a) + d,
                t._modifier = t._prelim - c,
                OrgChart.local._apportion(t, e, r, a)
            } else
                a.orientation <= 3 ? t._prelim = c : t._prelim = 0
        } else if (null != (n = OrgChart.local._getLeftSibling(t))) {
            var d = a.siblingSeparation;
            if (t.isAssistant)
                d = a.assistantSeparation;
            else if (2 == n.layout)
                d = a.mixedHierarchyNodesSeparation;
            else if (n.parent && 4 == n.parent.hasPartners && a.orientation <= 3) {
                var g = OrgChart.local._size(n.parent, a)
                  , p = OrgChart.local._rightMidPoint(n, a);
                (d = n.parent.partnerSeparation + g / 2 - p) < a.siblingSeparation && (d = a.siblingSeparation)
            }
            t._prelim = n._prelim + OrgChart.local._nodeWithPartnersSize(n, a) + d
...
,
OrgChart.local._secondWalk = function(t, e, r, i, a, n, o) {
    if (e <= OrgChart.MAX_DEPTH && !t.isPartner) {
        var l, s = t._prelim + r, h = i, c = 0;
        switch (c = a[e],
        l = OrgChart.local._getNodeHeight(t, o),
        t.layout && !t.isSplit ? c = l : t.layout && t.isSplit && (t.leftNeighbor && t.leftNeighbor.layout && -1 == t.leftNeighbor.id.toString().indexOf("mirror") ? c = OrgChart.local._getNodeHeight(t.leftNeighbor, o) : t.rightNeighbor && t.rightNeighbor.layout && -1 == t.rightNeighbor.id.toString().indexOf("mirror") && (c = OrgChart.local._getNodeHeight(t.rightNeighbor, o))),
        t.x = s,
        t.y = h,
        t.hasPartners && OrgChart.local.nodeHasPartnersPosition(t, o, c),
        (t.isSplit || t.isAssistant || 2 == t.layout) && (t.y = h + c / 2 - l / 2),
        o.orientation) {
        case OrgChart.orientation.right:
        case OrgChart.orientation.right_top:
        case OrgChart.orientation.left:
        ...
        if (OrgChart._setMinMaxXY(t, n),
        0 != t.children) {
            var g = o.levelSeparation;
            t.layout && (g = o.mixedHierarchyNodesSeparation);
            var p = 0;
            if (OrgChart.local._secondWalk(t.children[p], e + 1, r + t._modifier, i + c + g, a, n, o),
            t.children[p].isPartner) {
                for (; t.children.length - 1 > p && t.children[p].isPartner; )
                    p++;
                OrgChart.local._secondWalk(t.children[p], e + 1, r + t._modifier, i + c + g, a, n, o)
            }
        }
        var f = OrgChart.local._getRightSibling(t);
        null != f && OrgChart.local._secondWalk(f, e, r, i, a, n, o)
    } else
        OrgChart.local.nodeIsPartnerPosition(t, o, a, e)
}
,
OrgChart.local._lastWalk = function(t, e, r, i, a) {
    t.x += e + a[3] - i.minX,
    t.y += r + a[0] - i.minY;
    for (var n = t.children.length, o = 0; o < n; o++) {
        var l = t.children[o];
        OrgChart.local._lastWalk(l, e, r, i, a)
    }
}
,
OrgChart.local._apportion = function(t, e, r, i) {
    if (!t.isPartner)
        for (var a = OrgChart.local._fChild(t), n = a.leftNeighbor, o = 1, l = OrgChart.MAX_DEPTH - e; null != a && null != n && o <= l; ) {
            for (var s = 0, h = 0, c = a, d = n, g = 0; g < o; g++)
                c = c.parent,
                d = d.parent,
                s += c._modifier,
                h += d._modifier;
            var p = i.subtreeSeparation;
            t.leftNeighbor && 2 == t.leftNeighbor.layout && (p = 0);
            var f = n._prelim + h + OrgChart.local._nodeWithPartnersSize(n, i) + p - (a._prelim + s);
            if (f > 0) {
                for (var u = t, m = 0; null != u && u != d; u = OrgChart.local._getLeftSibling(u))
                    m++;
                if (null != u)
                    for (var C = t, b = f / m; C != d; C = OrgChart.local._getLeftSibling(C)) {
                        var O = !0;
                        if (C.layout) {
                            var v = r[e]
                              , x = {
                                config: i,
                                node: t,
                                size: -i.mixedHierarchyNodesSeparation
                            };
                            if (-1 != x.node.id.toString().indexOf("mirror"))
                                for (var y = x.node.id.toString().replace("_mirror", ""), _ = 0; _ < x.node.parent.children.length; _++)
                                    if (x.node.parent.children[_].id == y) {
                                        x.node = x.node.parent.children[_];
                                        break
                                    }
                            OrgChart.local._mixedTreeHeight(x),
                            O = v < x.size
                        }
                        O && (C._prelim += f,
                        C._modifier += f,
            ...
            o++,
            null != (a = OrgChart.local._hasChildren(a) ? OrgChart.local._fChild(a) : OrgChart.local._getLeftmost(t, 0, o)) && (n = a.leftNeighbor)
        }
}
,
OrgChart.local._mixedTreeHeight = function(t) {
    t.size += OrgChart.local._getNodeHeight(t.node, t.config) + t.config.mixedHierarchyNodesSeparation;
    for (var e = 0; e < t.node.children.length; e++)
        t.node = t.node.children[e],
        OrgChart.local._mixedTreeHeight(t)
}
,
OrgChart.local._setLevelMaxNodeHeight = function(t, e, r, i) {
    null == r[e] && (r[e] = 0);
    var a = OrgChart.local._getNodeHeight(t, i);
    r[e] < a && (r[e] = a)
}
,
OrgChart.local._setNeighbors = function(t, e, r) {
    r[e] && r[e].id === t.id || (t.leftNeighbor = r[e],
    null != t.leftNeighbor && (t.leftNeighbor.rightNeighbor = t),
    t.isPartner || (r[e] = t))
}
,
OrgChart.local._nodeWithPartnersSize = function(t, e) {
    switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left:
        return OrgChart.local._getPartnerRightPanelWidth(t, e) + t.w + OrgChart.local._getPartnerLeftPanelWidth(t, e);
    case OrgChart.orientation.right:
    case OrgChart.orientation.right_top:
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top:
        return OrgChart.local._getPartnerRightPanelHeight(t, e) + t.h + OrgChart.local._getPartnerLeftPanelHeight(t, e)
    }
    return 0
}
,
OrgChart.local._size = function(t, e) {
    switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
...
,
OrgChart.local._leftMidPoint = function(t, e) {
    switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left:
        return OrgChart.local._getPartnerLeftPanelWidth(t, e) + t.w / 2;
    case OrgChart.orientation.right:
    case OrgChart.orientation.right_top:
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top:
        return OrgChart.local._getPartnerLeftPanelHeight(t, e) + t.h / 2
    }
    return 0
}
,
OrgChart.local._rightMidPoint = function(t, e) {
    switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left:
        return OrgChart.local._getPartnerRightPanelWidth(t, e) + t.w / 2;
    case OrgChart.orientation.right:
    case OrgChart.orientation.right_top:
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top:
        return OrgChart.local._getPartnerRightPanelHeight(t, e) + t.h / 2
    }
    return 0
}
,
OrgChart.local._mid = function(t, e) {
    switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left:
        switch (t.hasPartners) {
        case 2:
            return OrgChart.local._getPartnerLeftPanelWidth(t, e) - t.partnerSeparation / 2;
        case 3:
            return OrgChart.local._getPartnerLeftPanelWidth(t, e) + t.w + t.partnerSeparation / 2;
        case 4:
            if (e.orientation <= 3) {
                var r = OrgChart.local._rightMidPoint(OrgChart.local._fChild(t), e)
                  , i = OrgChart.local._leftMidPoint(t.children[t.children.length - 1], e);
                return OrgChart.local._getPartnerLeftPanelWidth(t, e) + t.w / 2 + (i - r) / 2
            }
            return OrgChart.local._getPartnerLeftPanelWidth(t, e) + t.w / 2;
        default:
            return OrgChart.local._getPartnerLeftPanelWidth(t, e) + t.w / 2
    ...
    case OrgChart.orientation.left_top:
        switch (t.hasPartners) {
        case 2:
            return OrgChart.local._getPartnerLeftPanelHeight(t, e) - t.partnerSeparation / 2;
        case 3:
            return OrgChart.local._getPartnerLeftPanelHeight(t, e) + t.h + t.partnerSeparation / 2;
        case 4:
            if (e.orientation <= 3) {
                r = OrgChart.local._rightMidPoint(OrgChart.local._fChild(t), e),
                i = OrgChart.local._leftMidPoint(t.children[t.children.length - 1], e);
                return OrgChart.local._getPartnerLeftPanelHeight(t, e) + t.h / 2 + (i - r) / 2
            }
            return OrgChart.local._getPartnerLeftPanelHeight(t, e) + t.h / 2;
        default:
            return OrgChart.local._getPartnerLeftPanelHeight(t, e) + t.h / 2
...
,
OrgChart.local._getNodeHeight = function(t, e) {
    switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left:
        return Math.max(OrgChart.local._getPartnerRightPanelHeight(t, e), t.h, OrgChart.local._getPartnerLeftPanelHeight(t, e));
    case OrgChart.orientation.right:
    case OrgChart.orientation.right_top:
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top:
        return Math.max(OrgChart.local._getPartnerRightPanelWidth(t, e), t.w, OrgChart.local._getPartnerLeftPanelWidth(t, e))
    }
    return 0
}
,
OrgChart.local._getLeftSibling = function(t) {
    return null != t.leftNeighbor && t.leftNeighbor.parent == t.parent ? t.leftNeighbor : null
}
,
OrgChart.local._getRightSibling = function(t) {
    return null != t.rightNeighbor && t.rightNeighbor.parent == t.parent ? t.rightNeighbor : null
}
,
OrgChart.local._getLeftmost = function(t, e, r) {
    if (e >= r)
        return t;
    if (!OrgChart.local._hasChildren(t))
        return null;
    for (var i = t.children.length, a = 0; a < i; a++) {
        var n = t.children[a];
        if (!n.isPartner) {
            var o = OrgChart.local._getLeftmost(n, e + 1, r);
            if (null != o)
                return o
        }
    }
...
,
OrgChart.local.nodeHasPartnersPosition = function(t, e, r) {
    switch (e.orientation) {
    case OrgChart.orientation.top:
    case OrgChart.orientation.top_left:
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left:
        var i = OrgChart.local._getPartnerLeftPanelWidth(t, e);
        t.x += i,
        t.h < r && (e.orientation == OrgChart.orientation.bottom || e.orientation == OrgChart.orientation.bottom_left ? t.y -= (r - t.h) / 2 : t.y += (r - t.h) / 2);
        break;
    case OrgChart.orientation.right:
    case OrgChart.orientation.right_top:
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top:
        var a = OrgChart.local._getPartnerLeftPanelHeight(t, e);
        t.x += a,
        t.w < r && (e.orientation == OrgChart.orientation.right || e.orientation == OrgChart.orientation.right_top ? t.y -= (r - t.w) / 2 : t.y += (r - t.w) / 2)
    }
}
,
OrgChart.local.nodeIsPartnerPosition = function(t, e, r, i) {
    var a = 0
      , n = 0
      , o = 0
      , l = 0
    ...
    case OrgChart.orientation.bottom:
    case OrgChart.orientation.bottom_left:
        a = OrgChart.local._getPartnerLeftPanelHeight(t.parent, e),
        n = OrgChart.local._getPartnerRightPanelHeight(t.parent, e);
        for (var f = 0; f < t.parent.children.length; f++) {
            1 == (u = t.parent.children[f]).isPartner ? (o = t.parent.x + t.parent.w + t.parent.partnerSeparation,
            g ? (l = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - n) / 2,
            d = u.h,
            g = !1) : (l += d + e.partnerNodeSeparation,
            d = u.h),
            u.x = o,
            u.y = l) : 2 == u.isPartner && (s = t.parent.x - u.w - t.parent.partnerSeparation,
            p ? (h = t.parent.y - (r[i - 1] - t.parent.h) / 2 + (r[i - 1] - a) / 2,
            c = u.h,
            p = !1) : (h += c + e.partnerNodeSeparation,
            c = u.h),
            u.x = s,
            u.y = h)
        }
    ...
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top:
        a = OrgChart.local._getPartnerLeftPanelWidth(t.parent, e),
        n = OrgChart.local._getPartnerRightPanelWidth(t.parent, e);
        for (f = 0; f < t.parent.children.length; f++) {
            var u;
            (u = t.parent.children[f]) && (1 == u.isPartner ? (l = t.parent.y + t.parent.h + t.parent.partnerSeparation,
            g ? (o = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - n) / 2,
            d = u.w,
            g = !1) : (o += d + e.partnerNodeSeparation,
            d = u.w),
            u.x = o,
            u.y = l) : 2 == u.isPartner && (h = t.parent.y - u.h - t.parent.partnerSeparation,
            p ? (s = t.parent.x - (r[i - 1] - t.parent.w) / 2 + (r[i - 1] - a) / 2,
            c = u.w,
            p = !1) : (s += c + e.partnerNodeSeparation,
            c = u.w),
            u.x = s,
            u.y = h))
        }
...
,
OrgChart.local._getPartnerRightPanelWidth = function(t, e) {
    if (!t.hasPartners)
        return 0;
    var r = 0;
    switch (e.orientation) {
    ...
    case OrgChart.orientation.bottom_left:
        for (var i = 0; i < t.children.length; i++) {
            1 == (a = t.children[i]).isPartner && a.w > r && (r = a.w)
        }
        return r && (r += t.partnerSeparation),
        r;
    case OrgChart.orientation.right:
    case OrgChart.orientation.right_top:
    case OrgChart.orientation.left:
    case OrgChart.orientation.left_top:
        for (i = 0; i < t.children.length; i++) {
            var a;
            1 == (a = t.children[i]).isPartner && (r += a.w + e.partnerNodeSeparation)
        }
        return r && (r -= e.partnerNodeSeparation),
        r
    }
}
,
OrgChart.local._getPartnerLeftPanelWidth = function(t, e) {
    if (!t.hasPartners)
        return 0;
    var r = 0;
    switch (e.orientation) {
    ...
    case OrgChart.orientation.bottom_left:
        for (var i = 0; i < t.children.length; i++) {
            2 == (a = t.children[i]).isPartner && a.w > r && (r = a.w)
        }
        return r && (r += t.partnerSeparation),
        r;
    case OrgChart.orientation.right:
    ...
    case OrgChart.orientation.left_top:
        for (i = 0; i < t.children.length; i++) {
            var a;
            2 == (a = t.children[i]).isPartner && (r += a.w + e.partnerNodeSeparation)
        }
        return r && (r -= e.partnerNodeSeparation),
        r
    }
...
,
OrgChart.local._getPartnerRightPanelHeight = function(t, e) {
    if (!t.hasPartners)
        return 0;
    var r = 0;
    switch (e.orientation) {
    ...
    case OrgChart.orientation.bottom_left:
        for (var i = 0; i < t.children.length; i++) {
            1 == (a = t.children[i]).isPartner && (r += a.h + e.partnerNodeSeparation)
        }
        return r && (r -= e.partnerNodeSeparation),
        r;
    case OrgChart.orientation.right:
    ...
    case OrgChart.orientation.left_top:
        for (i = 0; i < t.children.length; i++) {
            var a;
            1 == (a = t.children[i]).isPartner && a.h > r && (r = a.h)
        }
        return r && (r += t.partnerSeparation),
        r
    }
...
,
OrgChart.local._getPartnerLeftPanelHeight = function(t, e) {
    if (!t.hasPartners)
        return 0;
    var r = 0;
    switch (e.orientation) {
    ...
    case OrgChart.orientation.bottom_left:
        for (var i = 0; i < t.children.length; i++) {
            2 == (a = t.children[i]).isPartner && (r += a.h + e.partnerNodeSeparation)
        }
        return r && (r -= e.partnerNodeSeparation),
        r;
    case OrgChart.orientation.right:
    ...
    case OrgChart.orientation.left_top:
        for (i = 0; i < t.children.length; i++) {
            var a;
            2 == (a = t.children[i]).isPartner && a.h > r && (r = a.h)
        }
        return r && (r += t.partnerSeparation),
        r
    }
...
,
OrgChart.local._fChild = function(t) {
    for (var e = 0; e < t.children.length && t.children[e].isPartner; )
        e++;
    return t.children[e]
}
,
OrgChart.local._hasChildren = function(t) {
    for (var e = 0; e < t.children.length; e++)
        if (!t.children[e].isPartner)
            return !0;
    return !1
}
;
