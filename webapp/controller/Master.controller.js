sap.ui.define([
  ...
  return BaseController.extend("hayat.hcm.orgchart.md.controller.Master", {
    ...
    onInit: function () {
      ...
      this.getRouter().getRoute("detailDetail").attachPatternMatched(this._onMasterMatched, this);
    ...
    buildTree: function (oEvent, tData) {
      ...
      if (this._langu !== "") {
        ...
        _filter.push(new Filter("ILangu", FilterOperator.EQ, this._langu));
      }

      this.getOwnerComponent().getModel().read("/tListSet", {
        filters: _filter,
        //urlParameters: { "$select": "Objid,Stext,Pobjid" },
